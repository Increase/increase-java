...
[![Maven Central](https://img.shields.io/maven-central/v/com.increase.api/increase-java)](https://central.sonatype.com/artifact/com.increase.api/increase-java/0.210.0)
[![javadoc](https://javadoc.io/badge2/com.increase.api/increase-java/0.210.0/javadoc.svg)](https://javadoc.io/doc/com.increase.api/increase-java/0.210.0)
...
The REST API documentation can be found on [increase.com](https://increase.com/documentation). Javadocs are also available on [javadoc.io](https://javadoc.io/doc/com.increase.api/increase-java/0.210.0).
...
```kotlin
implementation("com.increase.api:increase-java:0.210.0")
```
