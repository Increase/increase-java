...
[![Maven Central](https://img.shields.io/maven-central/v/com.increase.api/increase-java)](https://central.sonatype.com/artifact/com.increase.api/increase-java/0.568.0)
[![javadoc](https://javadoc.io/badge2/com.increase.api/increase-java/0.568.0/javadoc.svg)](https://javadoc.io/doc/com.increase.api/increase-java/0.568.0)
...
The REST API documentation can be found on [increase.com](https://increase.com/documentation). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.increase.api/increase-java/0.568.0).
...
```kotlin
implementation("com.increase.api:increase-java:0.568.0")
```
...
These methods return [`HttpResponse`](increase-java-core/src/main/kotlin/com/increase/api/core/http/HttpResponse.kt):

```java
import com.increase.api.core.http.HttpResponse;
import com.increase.api.models.files.FileContentsParams;

HttpResponse response = client.files().contents("file_makxrc67oh9l6sg7w9yc");
```
...
try (HttpResponse response = client.files().contents(params)) {
    Files.copy(
        response.body(),
        Paths.get(path),
