...
[![Maven Central](https://img.shields.io/maven-central/v/com.increase.api/increase-java)](https://central.sonatype.com/artifact/com.increase.api/increase-java/0.126.0)
...
```kotlin
implementation("com.increase.api:increase-java:0.126.0")
```
