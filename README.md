...
[![Maven Central](https://img.shields.io/maven-central/v/com.increase.api/increase-java)](https://central.sonatype.com/artifact/com.increase.api/increase-java/0.24.0)
...
The REST API documentation can be found [on increase.com](https://increase.com/documentation). The full API of this library can be found in [api.md](https://www.github.com/increase/increase-java/blob/main/api.md).
...
```kotlin
implementation("com.increase.api:increase-java:0.24.0")
```
