...
internal class ExportCreateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.entityCsv()).contains(ExportCreateParams.EntityCsv.builder().build())
        ...
        assertThat(body.vendorCsv()).contains(ExportCreateParams.VendorCsv.builder().build())
