...
class CheckTransferCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.physicalCheck()).contains(CheckTransferCreateParams.PhysicalCheck.builder()
          .mailingAddress(CheckTransferCreateParams.PhysicalCheck.MailingAddress.builder()
              .city("New York")
              .line1("33 Liberty Street")
              .postalCode("10045")
      ...
      assertThat(body.thirdParty()).contains(CheckTransferCreateParams.ThirdParty.builder()
          .checkNumber("x")
          .build())
    }
