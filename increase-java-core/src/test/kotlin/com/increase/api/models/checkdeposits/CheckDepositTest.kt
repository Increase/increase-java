...
class CheckDepositTest {
    ...
    fun createCheckDeposit() {
      ...
      assertThat(checkDeposit.backImageFileId()).isEmpty
      ...
      assertThat(checkDeposit.idempotencyKey()).isEmpty
      assertThat(checkDeposit.inboundFundsHold()).contains(CheckDeposit.InboundFundsHold.builder()
          .id("id")
          .amount(0L)
          .automaticallyReleasesAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
