...
class CheckTransferTest {
    ...
    fun createCheckTransfer() {
        ...
        assertThat(checkTransfer.addressCity()).contains("string")
        assertThat(checkTransfer.addressLine1()).contains("string")
        assertThat(checkTransfer.addressLine2()).contains("string")
        assertThat(checkTransfer.addressState()).contains("string")
        assertThat(checkTransfer.addressZip()).contains("string")
        ...
        assertThat(checkTransfer.uniqueIdentifier()).contains("string")
    }
}
