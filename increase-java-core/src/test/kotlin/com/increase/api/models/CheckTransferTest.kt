...
class CheckTransferTest {
    ...
    fun createCheckTransfer() {
      val checkTransfer = CheckTransfer.builder()
          ...
          .addressState("string")
          .addressZip("string")
          .returnAddress(CheckTransfer.ReturnAddress.builder()
              .name("string")
              .line1("string")
              .line2("string")
              .city("string")
          ...
          .stopPaymentRequest(CheckTransfer.StopPaymentRequest.builder()
              ...
              .build())
          .deposit(CheckTransfer.Deposit.builder()
              .frontImageFileId("string")
              .backImageFileId("string")
              .type(CheckTransfer.Deposit.Type.CHECK_TRANSFER_DEPOSIT)
              .build())
          .returnDetails(CheckTransfer.ReturnDetails.builder()
              .transferId("string")
              .fileId("string")
      ...
      assertThat(checkTransfer.addressLine2()).contains("string")
      ...
      assertThat(checkTransfer.returnAddress()).contains(CheckTransfer.ReturnAddress.builder()
          .name("string")
          .line1("string")
          .line2("string")
          .city("string")
      ...
      assertThat(checkTransfer.mailedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(checkTransfer.message()).isEqualTo("string")
      assertThat(checkTransfer.note()).contains("string")
      ...
      assertThat(checkTransfer.submittedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(checkTransfer.submission()).contains(CheckTransfer.Submission.builder()
          .checkNumber("string")
          .build())
      assertThat(checkTransfer.templateId()).contains("string")
      assertThat(checkTransfer.transactionId()).contains("string")
      assertThat(checkTransfer.stopPaymentRequest()).contains(CheckTransfer.StopPaymentRequest.builder()
          ...
          .type(CheckTransfer.StopPaymentRequest.Type.CHECK_TRANSFER_STOP_PAYMENT_REQUEST)
          .build())
      assertThat(checkTransfer.deposit()).contains(CheckTransfer.Deposit.builder()
          .frontImageFileId("string")
          .backImageFileId("string")
          .type(CheckTransfer.Deposit.Type.CHECK_TRANSFER_DEPOSIT)
          .build())
      assertThat(checkTransfer.returnDetails()).contains(CheckTransfer.ReturnDetails.builder()
          .transferId("string")
          .fileId("string")
          .reason(CheckTransfer.ReturnDetails.Reason.MAIL_DELIVERY_FAILURE)
          .build())
