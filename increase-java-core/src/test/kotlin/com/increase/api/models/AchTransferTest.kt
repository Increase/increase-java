...
class AchTransferTest {
    ...
    fun createAchTransfer() {
      val achTransfer = AchTransfer.builder()
          ...
          .notificationOfChange(AchTransfer.NotificationOfChange.builder()
              .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .changeCode("string")
      ...
      assertThat(achTransfer.notificationOfChange()).contains(AchTransfer.NotificationOfChange.builder()
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .changeCode("string")
          .correctedData("string")
          .build())
      ...
      assertThat(achTransfer.submission()).contains(AchTransfer.Submission.builder()
          ...
          .submittedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(achTransfer.templateId()).contains("string")
