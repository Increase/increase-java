...
class CheckTransferTest {
    ...
    fun createCheckTransfer() {
      ...
      assertThat(checkTransfer.approval()).contains(CheckTransfer.Approval.builder()
          ...
          .approvedBy("approved_by")
          .build())
      assertThat(checkTransfer.approvedInboundCheckDepositId()).contains("inbound_check_deposit_zoshvqybq0cjjm31mra")
      ...
      assertThat(checkTransfer.mailing()).contains(CheckTransfer.Mailing.builder()
          ...
          .trackingNumber(null)
          .build())
      assertThat(checkTransfer.pendingTransactionId()).contains("pending_transaction_k1sfetcau2qbvjbzgju4")
      ...
      assertThat(checkTransfer.sourceAccountNumberId()).contains("account_number_v18nkfqm6afpsrvy82b2")
