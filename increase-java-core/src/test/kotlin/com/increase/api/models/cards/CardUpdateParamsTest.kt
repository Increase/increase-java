...
class CardUpdateParamsTest {
    ...
    fun body() {
      ...
      assertNotNull(body)
      assertThat(body.billingAddress()).contains(CardUpdateParams.BillingAddress.builder()
          .city("x")
          .line1("x")
          .postalCode("x")
          .state("x")
      ...
      assertThat(body.digitalWallet()).contains(CardUpdateParams.DigitalWallet.builder()
          .digitalCardProfileId("digital_card_profile_id")
          .email("x")
          .phone("x")
          .build())
