...
class CardAuthorizationCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.declineReason()).contains(CardAuthorizationCreateParams.DeclineReason.ACCOUNT_CLOSED)
      ...
      assertThat(body.eventSubscriptionId()).contains("event_subscription_001dzz0r20rcdxgb013zqb8m04g")
      ...
      assertThat(body.networkDetails()).contains(CardAuthorizationCreateParams.NetworkDetails.builder()
          .visa(CardAuthorizationCreateParams.NetworkDetails.Visa.builder()
              .standInProcessingReason(CardAuthorizationCreateParams.NetworkDetails.Visa.StandInProcessingReason.ISSUER_ERROR)
              .build())
          .build())
