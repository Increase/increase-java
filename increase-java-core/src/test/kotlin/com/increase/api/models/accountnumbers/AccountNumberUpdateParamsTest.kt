...
class AccountNumberUpdateParamsTest {
    ...
    fun body() {
      ...
      assertNotNull(body)
      assertThat(body.inboundAch()).contains(AccountNumberUpdateParams.InboundAch.builder()
          .debitStatus(AccountNumberUpdateParams.InboundAch.DebitStatus.ALLOWED)
          .build())
      assertThat(body.inboundChecks()).contains(AccountNumberUpdateParams.InboundChecks.builder()
          .status(AccountNumberUpdateParams.InboundChecks.Status.ALLOWED)
          .build())
