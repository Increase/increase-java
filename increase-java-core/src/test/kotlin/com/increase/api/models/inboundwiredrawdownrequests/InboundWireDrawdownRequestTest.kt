...
class InboundWireDrawdownRequestTest {
    ...
    fun createInboundWireDrawdownRequest() {
      ...
      assertThat(inboundWireDrawdownRequest.beneficiaryAddressLine1()).contains("33 Liberty Street")
      assertThat(inboundWireDrawdownRequest.beneficiaryAddressLine2()).contains("New York, NY, 10045")
      ...
      assertThat(inboundWireDrawdownRequest.originatorAddressLine1()).contains("33 Liberty Street")
      assertThat(inboundWireDrawdownRequest.originatorAddressLine2()).contains("New York, NY, 10045")
