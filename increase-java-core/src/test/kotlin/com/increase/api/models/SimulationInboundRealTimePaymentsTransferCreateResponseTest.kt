...
class SimulationInboundRealTimePaymentsTransferCreateResponseTest {
    ...
    fun createSimulationInboundRealTimePaymentsTransferCreateResponse() {
      ...
      assertThat(simulationInboundRealTimePaymentsTransferCreateResponse.declinedTransaction()).contains(DeclinedTransaction.builder()
          .id("id")
          .accountId("account_id")
          .amount(123L)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          ...
          .type(DeclinedTransaction.Type.DECLINED_TRANSACTION)
          .build())
      assertThat(simulationInboundRealTimePaymentsTransferCreateResponse.transaction()).contains(Transaction.builder()
          .id("id")
          .accountId("account_id")
          .amount(123L)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
