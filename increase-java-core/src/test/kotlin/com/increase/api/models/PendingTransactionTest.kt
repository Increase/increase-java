      ...
      val pendingTransaction = PendingTransaction.builder()
          ...
          .source(PendingTransaction.Source.builder()
              ...
              .inboundFundsHold(PendingTransaction.Source.InboundFundsHold.builder()
                  ...
                  .build())
              .cardRouteAuthorization(PendingTransaction.Source.CardRouteAuthorization.builder()
                  .amount(123L)
                  ...
                  .build())
              .wireDrawdownPaymentInstruction(PendingTransaction.Source.WireDrawdownPaymentInstruction.builder()
                  .amount(123L)
