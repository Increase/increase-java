...
class AchTransferCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.addenda()).contains(AchTransferCreateParams.Addenda.builder()
          .category(AchTransferCreateParams.Addenda.Category.FREEFORM)
          .freeform(AchTransferCreateParams.Addenda.Freeform.builder()
              .addEntry(AchTransferCreateParams.Addenda.Freeform.Entry.builder()
                  .paymentRelatedInformation("x")
      ...
      assertThat(body.destinationAccountHolder()).contains(AchTransferCreateParams.DestinationAccountHolder.BUSINESS)
      ...
      assertThat(body.preferredEffectiveDate()).contains(AchTransferCreateParams.PreferredEffectiveDate.builder()
          .date(LocalDate.parse("2019-12-27"))
          .settlementSchedule(AchTransferCreateParams.PreferredEffectiveDate.SettlementSchedule.SAME_DAY)
          .build())
      assertThat(body.requireApproval()).contains(true)
      assertThat(body.routingNumber()).contains("101050001")
      assertThat(body.standardEntryClassCode()).contains(AchTransferCreateParams.StandardEntryClassCode.CORPORATE_CREDIT_OR_DEBIT)
      assertThat(body.transactionTiming()).contains(AchTransferCreateParams.TransactionTiming.SYNCHRONOUS)
    }
