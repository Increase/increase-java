...
class IntrafiExclusionTest {
    ...
    fun createIntrafiExclusion() {
      ...
      assertThat(intrafiExclusion.excludedAt()).contains(OffsetDateTime.parse("2020-02-01T23:59:59+00:00"))
      ...
      assertThat(intrafiExclusion.submittedAt()).contains(OffsetDateTime.parse("2020-02-01T00:59:59+00:00"))
