...
class AchTransferTest {
    ...
    fun createAchTransfer() {
      ...
      assertThat(achTransfer.externalAccountId()).contains("external_account_ukk55lr923a3ac0pp7iv")
      assertThat(achTransfer.funding()).isEqualTo(AchTransfer.Funding.CHECKING)
      assertThat(achTransfer.idempotencyKey()).isEmpty
      assertThat(achTransfer.inboundFundsHold()).contains(AchTransfer.InboundFundsHold.builder()
          .id("id")
          .amount(0L)
          .automaticallyReleasesAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(achTransfer.settlement()).contains(AchTransfer.Settlement.builder()
          .settledAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
