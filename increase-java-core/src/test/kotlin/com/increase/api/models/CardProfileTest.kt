...
class CardProfileTest {
    ...
    fun createCardProfile() {
      val cardProfile = CardProfile.builder()
          .id("string")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .status(CardProfile.Status.PENDING)
          .description("string")
          .digitalWallets(CardProfile.DigitalWallets.builder()
              .textColor(CardProfile.DigitalWallets.TextColor.builder()
                  .red(123L)
                  .green(123L)
                  .blue(123L)
                  .build())
      ...
      assertThat(cardProfile.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(cardProfile.status()).isEqualTo(CardProfile.Status.PENDING)
      assertThat(cardProfile.description()).isEqualTo("string")
      assertThat(cardProfile.digitalWallets()).isEqualTo(CardProfile.DigitalWallets.builder()
          .textColor(CardProfile.DigitalWallets.TextColor.builder()
              .red(123L)
              .green(123L)
              .blue(123L)
