...
class CardAuthorizationCreateResponseTest {
    ...
    fun createCardAuthorizationCreateResponse() {
      ...
      assertThat(cardAuthorizationCreateResponse.declinedTransaction()).contains(DeclinedTransaction.builder()
          .id("id")
          .accountId("account_id")
          .amount(0L)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          ...
          .type(DeclinedTransaction.Type.DECLINED_TRANSACTION)
          .build())
      assertThat(cardAuthorizationCreateResponse.pendingTransaction()).contains(PendingTransaction.builder()
          .id("pending_transaction_k1sfetcau2qbvjbzgju4")
          .accountId("account_in71c4amph0vgo2qllky")
          .amount(100L)
          .completedAt(null)
