...
import com.increase.api.models.SimulationsWireTransferCreateInboundParams.SimulationsWireTransferCreateInboundBody
...
class SimulationsWireTransferCreateInboundParamsTest {
    ...
    @Test
    fun getBody() {
      val params = SimulationsWireTransferCreateInboundParams.builder()
          .accountNumberId("string")
          .amount(123L)
          .beneficiaryAddressLine1("x")
          .beneficiaryAddressLine2("x")
