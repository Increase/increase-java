...
class InboundFundsHoldReleaseResponseTest {
    ...
    fun createInboundFundsHoldReleaseResponse() {
      ...
      assertThat(inboundFundsHoldReleaseResponse.heldTransactionId()).contains("transaction_uyrp7fld2ium70oa7oi")
      assertThat(inboundFundsHoldReleaseResponse.pendingTransactionId()).contains("pending_transaction_k1sfetcau2qbvjbzgju4")
