...
class DigitalCardProfileServiceAsyncTest {
    ...
    fun create() {
      ...
      val digitalCardProfileFuture = digitalCardProfileServiceAsync.create(DigitalCardProfileCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val digitalCardProfileFuture = digitalCardProfileServiceAsync.retrieve(DigitalCardProfileRetrieveParams.builder()
    ...
    fun archive() {
      ...
      val digitalCardProfileFuture = digitalCardProfileServiceAsync.archive(DigitalCardProfileArchiveParams.builder()
          .digitalCardProfileId("digital_card_profile_s3puplu90f04xhcwkiga")
          .build())
    ...
    fun clone() {
      ...
      val digitalCardProfileFuture = digitalCardProfileServiceAsync.clone(DigitalCardProfileCloneParams.builder()
          .digitalCardProfileId("digital_card_profile_s3puplu90f04xhcwkiga")
