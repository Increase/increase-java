...
class LimitServiceTest {
    ...
    fun callCreate() {
      ...
      val limit = limitService.create(LimitCreateParams.builder()
    ...
    fun callRetrieve() {
      val client = IncreaseOkHttpClient.builder()
          ...
          .build()
      val limitService = client.limits()
      val limit = limitService.retrieve(LimitRetrieveParams.builder()
          .limitId("string")
          .build())
      println(limit)
      limit.validate()
    ...
    fun callUpdate() {
      val client = IncreaseOkHttpClient.builder()
          ...
          .build()
      val limitService = client.limits()
      val limit = limitService.update(LimitUpdateParams.builder()
          .limitId("string")
