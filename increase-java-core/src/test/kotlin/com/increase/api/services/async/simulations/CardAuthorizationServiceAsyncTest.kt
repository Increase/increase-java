...
class CardAuthorizationServiceAsyncTest {
    ...
    fun create() {
      ...
      val cardAuthorizationFuture = cardAuthorizationServiceAsync.create(CardAuthorizationCreateParams.builder()
          .amount(1000L)
      ...
      val cardAuthorization = cardAuthorizationFuture.get()
