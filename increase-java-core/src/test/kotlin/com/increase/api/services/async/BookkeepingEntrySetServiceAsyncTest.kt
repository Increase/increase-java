...
class BookkeepingEntrySetServiceAsyncTest {
    ...
    fun create() {
      ...
      val bookkeepingEntrySetFuture = bookkeepingEntrySetServiceAsync.create(BookkeepingEntrySetCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val bookkeepingEntrySetFuture = bookkeepingEntrySetServiceAsync.retrieve(BookkeepingEntrySetRetrieveParams.builder()
    ...
    fun list() {
      ...
      val pageFuture = bookkeepingEntrySetServiceAsync.list()
