...
class ProofOfAuthorizationRequestSubmissionServiceAsyncTest {
    ...
    fun create() {
      ...
      val proofOfAuthorizationRequestSubmissionFuture = proofOfAuthorizationRequestSubmissionServiceAsync.create(ProofOfAuthorizationRequestSubmissionCreateParams.builder()
      ...
      val proofOfAuthorizationRequestSubmission = proofOfAuthorizationRequestSubmissionFuture.get()
    ...
    fun retrieve() {
      ...
      val proofOfAuthorizationRequestSubmissionFuture = proofOfAuthorizationRequestSubmissionServiceAsync.retrieve(ProofOfAuthorizationRequestSubmissionRetrieveParams.builder()
