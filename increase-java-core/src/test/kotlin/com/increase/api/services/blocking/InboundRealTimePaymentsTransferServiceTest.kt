...
class InboundRealTimePaymentsTransferServiceTest {
    ...
    fun callList() {
      val client = IncreaseOkHttpClient.builder()
          ...
          .build()
      val inboundRealTimePaymentsTransferService = client.inboundRealTimePaymentsTransfers()
      val inboundRealTimePaymentsTransferList = inboundRealTimePaymentsTransferService.list(InboundRealTimePaymentsTransferListParams.builder().build())
      println(inboundRealTimePaymentsTransferList)
      inboundRealTimePaymentsTransferList.data().forEach {
          it.validate()
      }
    }
}
