...
class RealTimeDecisionServiceAsyncTest {
    ...
    fun retrieve() {
      ...
      val realTimeDecisionFuture = realTimeDecisionServiceAsync.retrieve(RealTimeDecisionRetrieveParams.builder()
    ...
    fun action() {
      ...
      val realTimeDecisionFuture = realTimeDecisionServiceAsync.action(RealTimeDecisionActionParams.builder()
          .realTimeDecisionId("real_time_decision_j76n2e810ezcg3zh5qtn")
