...
class WireTransferServiceAsyncTest {
    ...
    fun create() {
      ...
      val wireTransferFuture = wireTransferServiceAsync.create(WireTransferCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val wireTransferFuture = wireTransferServiceAsync.retrieve(WireTransferRetrieveParams.builder()
    ...
    fun approve() {
      ...
      val wireTransferFuture = wireTransferServiceAsync.approve(WireTransferApproveParams.builder()
          .wireTransferId("wire_transfer_5akynk7dqsq25qwk9q2u")
          .build())
    ...
    fun cancel() {
      ...
      val wireTransferFuture = wireTransferServiceAsync.cancel(WireTransferCancelParams.builder()
          .wireTransferId("wire_transfer_5akynk7dqsq25qwk9q2u")
          .build())
