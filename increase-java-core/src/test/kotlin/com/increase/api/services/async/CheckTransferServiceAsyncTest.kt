...
class CheckTransferServiceAsyncTest {
    ...
    fun create() {
      ...
      val checkTransferFuture = checkTransferServiceAsync.create(CheckTransferCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val checkTransferFuture = checkTransferServiceAsync.retrieve(CheckTransferRetrieveParams.builder()
    ...
    fun approve() {
      ...
      val checkTransferFuture = checkTransferServiceAsync.approve(CheckTransferApproveParams.builder()
          .checkTransferId("check_transfer_30b43acfu9vw8fyc4f5")
          .build())
    ...
    fun cancel() {
      ...
      val checkTransferFuture = checkTransferServiceAsync.cancel(CheckTransferCancelParams.builder()
          .checkTransferId("check_transfer_30b43acfu9vw8fyc4f5")
          .build())
    ...
    fun stopPayment() {
      ...
      val checkTransferFuture = checkTransferServiceAsync.stopPayment(CheckTransferStopPaymentParams.builder()
          .checkTransferId("check_transfer_30b43acfu9vw8fyc4f5")
