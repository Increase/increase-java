...
class BookkeepingAccountServiceAsyncTest {
    ...
    fun create() {
      ...
      val bookkeepingAccountFuture = bookkeepingAccountServiceAsync.create(BookkeepingAccountCreateParams.builder()
          .name("New Account!")
    ...
    fun update() {
      ...
      val bookkeepingAccountFuture = bookkeepingAccountServiceAsync.update(BookkeepingAccountUpdateParams.builder()
    ...
    fun balance() {
      ...
      val bookkeepingBalanceLookupFuture = bookkeepingAccountServiceAsync.balance(BookkeepingAccountBalanceParams.builder()
          .bookkeepingAccountId("bookkeeping_account_e37p1f1iuocw5intf35v")
