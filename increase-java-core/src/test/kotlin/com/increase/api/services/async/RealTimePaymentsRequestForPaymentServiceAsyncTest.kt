...
class RealTimePaymentsRequestForPaymentServiceAsyncTest {
    ...
    fun create() {
        ...
        val realTimePaymentsRequestForPaymentFuture =
        ...
        val realTimePaymentsRequestForPayment = realTimePaymentsRequestForPaymentFuture.get()
    ...
    fun list() {
        ...
        val pageFuture = realTimePaymentsRequestForPaymentServiceAsync.list()
