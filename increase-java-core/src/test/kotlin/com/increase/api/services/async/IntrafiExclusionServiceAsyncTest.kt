...
class IntrafiExclusionServiceAsyncTest {
    ...
    fun create() {
      ...
      val intrafiExclusionFuture = intrafiExclusionServiceAsync.create(IntrafiExclusionCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val intrafiExclusionFuture = intrafiExclusionServiceAsync.retrieve(IntrafiExclusionRetrieveParams.builder()
    ...
    fun archive() {
      ...
      val intrafiExclusionFuture = intrafiExclusionServiceAsync.archive(IntrafiExclusionArchiveParams.builder()
