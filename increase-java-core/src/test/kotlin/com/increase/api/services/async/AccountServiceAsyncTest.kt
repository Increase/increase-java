...
class AccountServiceAsyncTest {
    ...
    fun create() {
      ...
      val accountFuture = accountServiceAsync.create(AccountCreateParams.builder()
          .name("New Account!")
    ...
    fun retrieve() {
      ...
      val accountFuture = accountServiceAsync.retrieve(AccountRetrieveParams.builder()
    ...
    fun update() {
      ...
      val accountFuture = accountServiceAsync.update(AccountUpdateParams.builder()
          .accountId("account_in71c4amph0vgo2qllky")
    ...
    fun balance() {
      ...
      val balanceLookupFuture = accountServiceAsync.balance(AccountBalanceParams.builder()
          .accountId("account_in71c4amph0vgo2qllky")
    ...
    fun close() {
      ...
      val accountFuture = accountServiceAsync.close(AccountCloseParams.builder()
          .accountId("account_in71c4amph0vgo2qllky")
          .build())
