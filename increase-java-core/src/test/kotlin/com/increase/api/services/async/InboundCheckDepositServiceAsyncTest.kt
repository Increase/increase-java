...
class InboundCheckDepositServiceAsyncTest {
    ...
    fun retrieve() {
      ...
      val inboundCheckDepositFuture = inboundCheckDepositServiceAsync.retrieve(InboundCheckDepositRetrieveParams.builder()
    ...
    fun decline() {
      ...
      val inboundCheckDepositFuture = inboundCheckDepositServiceAsync.decline(InboundCheckDepositDeclineParams.builder()
          .inboundCheckDepositId("inbound_check_deposit_zoshvqybq0cjjm31mra")
          .build())
    ...
    fun return_() {
      ...
      val inboundCheckDepositFuture = inboundCheckDepositServiceAsync.return_(InboundCheckDepositReturnParams.builder()
          .inboundCheckDepositId("inbound_check_deposit_zoshvqybq0cjjm31mra")
