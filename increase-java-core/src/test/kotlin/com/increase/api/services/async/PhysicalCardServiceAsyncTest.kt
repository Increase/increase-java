...
class PhysicalCardServiceAsyncTest {
    ...
    fun create() {
      ...
      val physicalCardFuture = physicalCardServiceAsync.create(PhysicalCardCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val physicalCardFuture = physicalCardServiceAsync.retrieve(PhysicalCardRetrieveParams.builder()
    ...
    fun update() {
      ...
      val physicalCardFuture = physicalCardServiceAsync.update(PhysicalCardUpdateParams.builder()
          .physicalCardId("physical_card_ode8duyq5v2ynhjoharl")
