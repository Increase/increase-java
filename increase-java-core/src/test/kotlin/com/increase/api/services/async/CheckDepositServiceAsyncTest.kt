...
class CheckDepositServiceAsyncTest {
    ...
    fun create() {
      ...
      val checkDepositFuture = checkDepositServiceAsync.create(CheckDepositCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val checkDepositFuture = checkDepositServiceAsync.retrieve(CheckDepositRetrieveParams.builder()
