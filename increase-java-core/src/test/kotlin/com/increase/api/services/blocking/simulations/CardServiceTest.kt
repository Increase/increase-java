...
class CardServiceTest {
    ...
    fun callAuthorize() {
      ...
      val cardAuthorizationSimulation = cardService.authorize(SimulationsCardAuthorizeParams.builder()
          .amount(123L)
          .cardId("string")
    ...
    fun callSettlement() {
      val client = IncreaseOkHttpClient.builder()
          ...
          .build()
      val cardService = client.simulations().cards()
      val transaction = cardService.settlement(SimulationsCardSettlementParams.builder()
          .cardId("string")
