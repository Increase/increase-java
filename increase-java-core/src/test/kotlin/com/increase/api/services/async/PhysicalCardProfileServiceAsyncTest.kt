...
class PhysicalCardProfileServiceAsyncTest {
    ...
    fun create() {
      ...
      val physicalCardProfileFuture = physicalCardProfileServiceAsync.create(PhysicalCardProfileCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val physicalCardProfileFuture = physicalCardProfileServiceAsync.retrieve(PhysicalCardProfileRetrieveParams.builder()
    ...
    fun archive() {
      ...
      val physicalCardProfileFuture = physicalCardProfileServiceAsync.archive(PhysicalCardProfileArchiveParams.builder()
          .physicalCardProfileId("physical_card_profile_m534d5rn9qyy9ufqxoec")
          .build())
    ...
    fun clone() {
      ...
      val physicalCardProfileFuture = physicalCardProfileServiceAsync.clone(PhysicalCardProfileCloneParams.builder()
          .physicalCardProfileId("physical_card_profile_m534d5rn9qyy9ufqxoec")
