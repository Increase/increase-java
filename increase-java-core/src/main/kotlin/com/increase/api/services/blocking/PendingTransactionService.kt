...
interface PendingTransactionService {
    ...
    /** @see [list] */
    fun list(params: PendingTransactionListParams = PendingTransactionListParams.none()): PendingTransactionListPage =
        list(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun retrieve(params: PendingTransactionRetrieveParams): HttpResponseFor<PendingTransaction> =
            retrieve(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun list(): HttpResponseFor<PendingTransactionListPage> = list(PendingTransactionListParams.none())
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: PendingTransactionListParams = PendingTransactionListParams.none()): HttpResponseFor<PendingTransactionListPage> =
            list(
              params, RequestOptions.none()
            )
