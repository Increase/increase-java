...
class PhysicalCardServiceAsyncImpl internal constructor(
    ...
    override fun advanceShipment(params: PhysicalCardAdvanceShipmentParams, requestOptions: RequestOptions): CompletableFuture<PhysicalCard> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun advanceShipment(params: PhysicalCardAdvanceShipmentParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PhysicalCard>> {
