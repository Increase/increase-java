...
interface PhysicalCardServiceAsync {
     ...
     */
    @JvmOverloads
    fun advanceShipment(params: SimulationPhysicalCardAdvanceShipmentParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<PhysicalCard>
}
