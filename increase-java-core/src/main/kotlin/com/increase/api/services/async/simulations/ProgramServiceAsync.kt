...
interface ProgramServiceAsync {
    ...
    /** @see [create] */
    fun create(params: ProgramCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Program>
    ...
    interface WithRawResponse {
        ...
        /** @see [create] */
        @MustBeClosed
        fun create(params: ProgramCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Program>>
    }
}
