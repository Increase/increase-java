...
interface BeneficialOwnerService {
    ...
    fun update(entityBeneficialOwnerId: String): EntityBeneficialOwner =
    ...
    fun update(
        entityBeneficialOwnerId: String,
        params: BeneficialOwnerUpdateParams = BeneficialOwnerUpdateParams.none(),
    ): EntityBeneficialOwner = update(entityBeneficialOwnerId, params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: BeneficialOwnerUpdateParams): EntityBeneficialOwner =
    ...
    fun archive(entityBeneficialOwnerId: String): EntityBeneficialOwner =
    ...
    fun archive(
        entityBeneficialOwnerId: String,
        params: BeneficialOwnerArchiveParams = BeneficialOwnerArchiveParams.none(),
    ): EntityBeneficialOwner = archive(entityBeneficialOwnerId, params, RequestOptions.none())
    ...
    /** @see archive */
    fun archive(params: BeneficialOwnerArchiveParams): EntityBeneficialOwner =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: BeneficialOwnerCreateParams): HttpResponseFor<EntityBeneficialOwner> =
            create(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun update(entityBeneficialOwnerId: String): HttpResponseFor<EntityBeneficialOwner> =
            update(entityBeneficialOwnerId, BeneficialOwnerUpdateParams.none())
        ...
        /** @see update */
        @MustBeClosed
        fun update(params: BeneficialOwnerUpdateParams): HttpResponseFor<EntityBeneficialOwner> =
            update(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun archive(entityBeneficialOwnerId: String): HttpResponseFor<EntityBeneficialOwner> =
            archive(entityBeneficialOwnerId, BeneficialOwnerArchiveParams.none())
        ...
        /** @see archive */
        @MustBeClosed
        fun archive(params: BeneficialOwnerArchiveParams): HttpResponseFor<EntityBeneficialOwner> =
            archive(params, RequestOptions.none())
