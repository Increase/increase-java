...
interface CheckTransferService {
     ...
     */
    @JvmOverloads
    fun deposit(params: SimulationsCheckTransferDepositParams, requestOptions: RequestOptions = RequestOptions.none()): CheckTransfer
     ...
     */
    @JvmOverloads
    fun mail(params: SimulationsCheckTransferMailParams, requestOptions: RequestOptions = RequestOptions.none()): CheckTransfer
     ...
     */
    @JvmOverloads
    fun return_(params: SimulationsCheckTransferReturnParams, requestOptions: RequestOptions = RequestOptions.none()): CheckTransfer
}
