...
class AccountTransferServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: AccountTransferCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AccountTransfer>> {
        ...
        override fun retrieve(params: AccountTransferRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AccountTransfer>> {
          val request = HttpRequest.builder()
        ...
        override fun list(params: AccountTransferListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AccountTransferListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("account_transfers")
            .build()
        ...
        override fun approve(params: AccountTransferApproveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AccountTransfer>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun cancel(params: AccountTransferCancelParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AccountTransfer>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
