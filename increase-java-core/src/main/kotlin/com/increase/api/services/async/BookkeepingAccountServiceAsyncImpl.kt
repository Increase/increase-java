...
class BookkeepingAccountServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: BookkeepingAccountCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BookkeepingAccount>> {
        ...
        override fun update(params: BookkeepingAccountUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BookkeepingAccount>> {
          val request = HttpRequest.builder()
        ...
        override fun list(params: BookkeepingAccountListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BookkeepingAccountListPageAsync>> {
          val request = HttpRequest.builder()
        ...
        override fun balance(params: BookkeepingAccountBalanceParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BookkeepingBalanceLookup>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
