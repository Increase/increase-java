...
interface InboundAchTransferService {
    ...
    /** @see [list] */
    fun list(params: InboundAchTransferListParams = InboundAchTransferListParams.none()): InboundAchTransferListPage =
        list(
          params, RequestOptions.none()
        )
    ...
    fun createNotificationOfChange(params: InboundAchTransferCreateNotificationOfChangeParams): InboundAchTransfer =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun retrieve(params: InboundAchTransferRetrieveParams): HttpResponseFor<InboundAchTransfer> =
            retrieve(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun list(): HttpResponseFor<InboundAchTransferListPage> = list(InboundAchTransferListParams.none())
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: InboundAchTransferListParams = InboundAchTransferListParams.none()): HttpResponseFor<InboundAchTransferListPage> =
            list(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun createNotificationOfChange(params: InboundAchTransferCreateNotificationOfChangeParams): HttpResponseFor<InboundAchTransfer> =
            createNotificationOfChange(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun transferReturn(params: InboundAchTransferTransferReturnParams): HttpResponseFor<InboundAchTransfer> =
            transferReturn(
              params, RequestOptions.none()
            )
