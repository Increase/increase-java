...
interface GroupService {
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun retrieve(): HttpResponseFor<Group> = retrieve(GroupRetrieveParams.none())
        ...
        /** @see [retrieve] */
        @MustBeClosed
        fun retrieve(params: GroupRetrieveParams = GroupRetrieveParams.none()): HttpResponseFor<Group> =
            retrieve(
              params, RequestOptions.none()
            )
