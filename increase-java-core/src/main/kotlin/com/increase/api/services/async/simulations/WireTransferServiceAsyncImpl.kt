...
class WireTransferServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun reverse(params: WireTransferReverseParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<WireTransfer>> {
        ...
        override fun submit(params: WireTransferSubmitParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<WireTransfer>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
