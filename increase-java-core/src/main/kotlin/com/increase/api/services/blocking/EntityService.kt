...
interface EntityService {
    ...
    /** Create an Entity */
    fun create(params: EntityCreateParams): Entity =
        create(
    ...
    /** Retrieve an Entity */
    fun retrieve(params: EntityRetrieveParams): Entity =
        retrieve(
          params, RequestOptions.none()
        )
    ...
    /** Archive an Entity */
    fun archive(params: EntityArchiveParams): Entity =
        archive(
          params, RequestOptions.none()
        )
     ...
     */
    fun confirm(params: EntityConfirmParams): Entity =
        confirm(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun archiveBeneficialOwner(params: EntityArchiveBeneficialOwnerParams): HttpResponseFor<Entity> =
            archiveBeneficialOwner(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun createBeneficialOwner(params: EntityCreateBeneficialOwnerParams): HttpResponseFor<Entity> =
            createBeneficialOwner(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun updateBeneficialOwnerAddress(params: EntityUpdateBeneficialOwnerAddressParams): HttpResponseFor<Entity> =
            updateBeneficialOwnerAddress(
              params, RequestOptions.none()
            )
