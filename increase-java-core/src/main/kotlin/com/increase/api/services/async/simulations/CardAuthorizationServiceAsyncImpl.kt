...
class CardAuthorizationServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : CardAuthorizationServiceAsync {
     ...
     */
    override fun create(params: SimulationCardAuthorizationCreateParams, requestOptions: RequestOptions): CompletableFuture<SimulationCardAuthorizationCreateResponse> {
