...
interface IntrafiAccountEnrollmentService {
    ...
    /** @see [list] */
    fun list(params: IntrafiAccountEnrollmentListParams = IntrafiAccountEnrollmentListParams.none()): IntrafiAccountEnrollmentListPage =
        list(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: IntrafiAccountEnrollmentCreateParams): HttpResponseFor<IntrafiAccountEnrollment> =
            create(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun retrieve(params: IntrafiAccountEnrollmentRetrieveParams): HttpResponseFor<IntrafiAccountEnrollment> =
            retrieve(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun list(): HttpResponseFor<IntrafiAccountEnrollmentListPage> = list(IntrafiAccountEnrollmentListParams.none())
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: IntrafiAccountEnrollmentListParams = IntrafiAccountEnrollmentListParams.none()): HttpResponseFor<IntrafiAccountEnrollmentListPage> =
            list(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun unenroll(params: IntrafiAccountEnrollmentUnenrollParams): HttpResponseFor<IntrafiAccountEnrollment> =
            unenroll(
              params, RequestOptions.none()
            )
