...
class IntrafiExclusionServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: IntrafiExclusionCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<IntrafiExclusion>> {
        ...
        override fun retrieve(params: IntrafiExclusionRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<IntrafiExclusion>> {
          val request = HttpRequest.builder()
        ...
        override fun list(params: IntrafiExclusionListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<IntrafiExclusionListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("intrafi_exclusions")
            .build()
        ...
        override fun archive(params: IntrafiExclusionArchiveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<IntrafiExclusion>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
