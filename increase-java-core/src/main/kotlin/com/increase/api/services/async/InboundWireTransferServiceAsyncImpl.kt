...
class InboundWireTransferServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: InboundWireTransferRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<InboundWireTransfer>> {
        ...
        override fun list(params: InboundWireTransferListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<InboundWireTransferListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
