...
class CheckDepositServiceAsyncImpl internal constructor(
    ...
    override fun reject(params: CheckDepositRejectParams, requestOptions: RequestOptions): CompletableFuture<CheckDeposit> =
        // post /simulations/check_deposits/{check_deposit_id}/reject
        withRawResponse().reject(params, requestOptions).thenApply { it.parse() }

    override fun return_(params: CheckDepositReturnParams, requestOptions: RequestOptions): CompletableFuture<CheckDeposit> =
        // post /simulations/check_deposits/{check_deposit_id}/return
        withRawResponse().return_(params, requestOptions).thenApply { it.parse() }

    override fun submit(params: CheckDepositSubmitParams, requestOptions: RequestOptions): CompletableFuture<CheckDeposit> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun reject(params: CheckDepositRejectParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CheckDeposit>> {
        ...
        override fun return_(params: CheckDepositReturnParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CheckDeposit>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun submit(params: CheckDepositSubmitParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CheckDeposit>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
