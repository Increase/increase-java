...
class AccountServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: AccountCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Account>> {
        ...
        override fun retrieve(params: AccountRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Account>> {
          val request = HttpRequest.builder()
        ...
        override fun update(params: AccountUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Account>> {
          val request = HttpRequest.builder()
        ...
        override fun list(params: AccountListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AccountListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("accounts")
            .build()
        ...
        override fun balance(params: AccountBalanceParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BalanceLookup>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun close(params: AccountCloseParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Account>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
