...
class AccountStatementServiceAsyncImpl internal constructor(
    ...
    override fun create(params: AccountStatementCreateParams, requestOptions: RequestOptions): CompletableFuture<AccountStatement> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: AccountStatementCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AccountStatement>> {
