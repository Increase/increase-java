...
class DigitalCardProfileServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: DigitalCardProfileCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<DigitalCardProfile>> {
        ...
        override fun retrieve(params: DigitalCardProfileRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<DigitalCardProfile>> {
          val request = HttpRequest.builder()
        ...
        override fun list(params: DigitalCardProfileListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<DigitalCardProfileListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("digital_card_profiles")
            .build()
        ...
        override fun archive(params: DigitalCardProfileArchiveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<DigitalCardProfile>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun clone(params: DigitalCardProfileCloneParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<DigitalCardProfile>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
