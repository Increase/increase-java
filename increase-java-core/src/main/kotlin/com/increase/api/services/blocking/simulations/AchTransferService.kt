...
interface AchTransferService {
     ...
     */
    @JvmOverloads
    fun createInbound(params: SimulationsAchTransferCreateInboundParams, requestOptions: RequestOptions = RequestOptions.none()): AchTransferSimulation
     ...
     */
    @JvmOverloads
    fun return_(params: SimulationsAchTransferReturnParams, requestOptions: RequestOptions = RequestOptions.none()): AchTransfer
     ...
     */
    @JvmOverloads
    fun submit(params: SimulationsAchTransferSubmitParams, requestOptions: RequestOptions = RequestOptions.none()): AchTransfer
}
