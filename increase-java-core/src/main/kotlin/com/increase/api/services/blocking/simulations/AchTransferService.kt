...
interface AchTransferService {
     ...
     */
    fun createNotificationOfChange(params: AchTransferCreateNotificationOfChangeParams): AchTransfer =
     ...
     */
    fun settle(params: AchTransferSettleParams): AchTransfer =
        settle(
          params, RequestOptions.none()
        )
     ...
     */
    fun submit(params: AchTransferSubmitParams): AchTransfer =
        submit(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun createNotificationOfChange(params: AchTransferCreateNotificationOfChangeParams): HttpResponseFor<AchTransfer> =
            createNotificationOfChange(
              params, RequestOptions.none()
            )
