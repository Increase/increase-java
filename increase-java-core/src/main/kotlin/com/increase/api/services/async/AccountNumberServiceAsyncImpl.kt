...
class AccountNumberServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: AccountNumberCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AccountNumber>> {
        ...
        override fun retrieve(params: AccountNumberRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AccountNumber>> {
          val request = HttpRequest.builder()
        ...
        override fun update(params: AccountNumberUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AccountNumber>> {
          val request = HttpRequest.builder()
        ...
        override fun list(params: AccountNumberListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AccountNumberListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("account_numbers")
            .build()
