...
class ProgramServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: ProgramRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Program>> {
        ...
        override fun list(params: ProgramListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ProgramListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
