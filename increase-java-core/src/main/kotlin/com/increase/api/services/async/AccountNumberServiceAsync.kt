...
interface AccountNumberServiceAsync {
    ...
    /** @see [list] */
    fun list(params: AccountNumberListParams = AccountNumberListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<AccountNumberListPageAsync>

    /** @see [list] */
    fun list(params: AccountNumberListParams = AccountNumberListParams.none()): CompletableFuture<AccountNumberListPageAsync> =
        list(
          params, RequestOptions.none()
        )

    /** @see [list] */
    fun list(requestOptions: RequestOptions): CompletableFuture<AccountNumberListPageAsync> = list(AccountNumberListParams.none(), requestOptions)
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: AccountNumberCreateParams): CompletableFuture<HttpResponseFor<AccountNumber>> =
            create(
              params, RequestOptions.none()
            )
        ...
        /** @see [create] */
        @MustBeClosed
        fun create(params: AccountNumberCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<AccountNumber>>
         ...
         */
        @MustBeClosed
        fun retrieve(params: AccountNumberRetrieveParams): CompletableFuture<HttpResponseFor<AccountNumber>> =
            retrieve(
              params, RequestOptions.none()
            )
        ...
        /** @see [retrieve] */
        @MustBeClosed
        fun retrieve(params: AccountNumberRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<AccountNumber>>
         ...
         */
        @MustBeClosed
        fun update(params: AccountNumberUpdateParams): CompletableFuture<HttpResponseFor<AccountNumber>> =
            update(
              params, RequestOptions.none()
            )
        ...
        /** @see [update] */
        @MustBeClosed
        fun update(params: AccountNumberUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<AccountNumber>>
         ...
         */
        @MustBeClosed
        fun list(): CompletableFuture<HttpResponseFor<AccountNumberListPageAsync>> = list(AccountNumberListParams.none())

        /** @see [list] */
        @MustBeClosed
        fun list(params: AccountNumberListParams = AccountNumberListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<AccountNumberListPageAsync>>

        /** @see [list] */
        @MustBeClosed
        fun list(params: AccountNumberListParams = AccountNumberListParams.none()): CompletableFuture<HttpResponseFor<AccountNumberListPageAsync>> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AccountNumberListPageAsync>> = list(AccountNumberListParams.none(), requestOptions)
    }
}
