...
interface DigitalWalletTokenRequestService {
     ...
     * Apple Pay.
     */
    fun create(params: DigitalWalletTokenRequestCreateParams): DigitalWalletTokenRequestCreateResponse =
        create(
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: DigitalWalletTokenRequestCreateParams): HttpResponseFor<DigitalWalletTokenRequestCreateResponse> =
            create(
              params, RequestOptions.none()
            )
