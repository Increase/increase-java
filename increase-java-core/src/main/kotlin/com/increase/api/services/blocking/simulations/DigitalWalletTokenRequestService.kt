...
interface DigitalWalletTokenRequestService {
     ...
     */
    @JvmOverloads
    fun create(params: SimulationsDigitalWalletTokenRequestCreateParams, requestOptions: RequestOptions = RequestOptions.none()): DigitalWalletTokenRequestCreateResponse
}
