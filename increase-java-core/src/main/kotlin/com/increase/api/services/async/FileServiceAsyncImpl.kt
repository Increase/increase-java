...
class FileServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: FileCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<File>> {
        ...
        override fun retrieve(params: FileRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<File>> {
          val request = HttpRequest.builder()
