...
interface LockboxService {
    ...
    /** Create a Lockbox */
    fun create(params: LockboxCreateParams): Lockbox =
        create(
    ...
    /** Retrieve a Lockbox */
    fun retrieve(params: LockboxRetrieveParams): Lockbox =
        retrieve(
          params, RequestOptions.none()
        )
    ...
    /** Update a Lockbox */
    fun update(params: LockboxUpdateParams): Lockbox =
        update(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(): HttpResponseFor<LockboxListPage> = list(LockboxListParams.none())
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: LockboxListParams = LockboxListParams.none()): HttpResponseFor<LockboxListPage> =
            list(
              params, RequestOptions.none()
            )
