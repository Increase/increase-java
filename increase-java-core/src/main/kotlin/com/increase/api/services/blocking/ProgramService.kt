...
interface ProgramService {
    ...
    /** Retrieve a Program */
    fun retrieve(params: ProgramRetrieveParams): Program =
        retrieve(
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(): HttpResponseFor<ProgramListPage> = list(ProgramListParams.none())
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: ProgramListParams = ProgramListParams.none()): HttpResponseFor<ProgramListPage> =
            list(
              params, RequestOptions.none()
            )
