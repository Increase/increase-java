...
interface WireTransferServiceAsync {
    ...
    @JvmOverloads
    fun createInbound(params: SimulationsWireTransferCreateInboundParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<WireTransferSimulation>
}
