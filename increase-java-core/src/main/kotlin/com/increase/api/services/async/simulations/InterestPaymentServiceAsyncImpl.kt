...
class InterestPaymentServiceAsyncImpl internal constructor(
    ...
    override fun create(params: InterestPaymentCreateParams, requestOptions: RequestOptions): CompletableFuture<Transaction> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: InterestPaymentCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Transaction>> {
