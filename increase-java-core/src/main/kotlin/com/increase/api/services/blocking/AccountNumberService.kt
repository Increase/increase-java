...
interface AccountNumberService {
    ...
    /** @see [list] */
    fun list(params: AccountNumberListParams = AccountNumberListParams.none()): AccountNumberListPage =
        list(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: AccountNumberListParams = AccountNumberListParams.none()): HttpResponseFor<AccountNumberListPage> =
            list(
              params, RequestOptions.none()
            )
