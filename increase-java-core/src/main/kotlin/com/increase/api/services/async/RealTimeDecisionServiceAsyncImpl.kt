...
class RealTimeDecisionServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: RealTimeDecisionRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<RealTimeDecision>> {
        ...
        override fun action(params: RealTimeDecisionActionParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<RealTimeDecision>> {
          val request = HttpRequest.builder()
