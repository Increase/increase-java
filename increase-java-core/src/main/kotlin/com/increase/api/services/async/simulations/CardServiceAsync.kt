...
interface CardServiceAsync {
     ...
     */
    @JvmOverloads
    fun authorize(params: SimulationsCardAuthorizeParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CardAuthorizationSimulation>
     ...
     */
    @JvmOverloads
    fun settlement(params: SimulationsCardSettlementParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Transaction>
}
