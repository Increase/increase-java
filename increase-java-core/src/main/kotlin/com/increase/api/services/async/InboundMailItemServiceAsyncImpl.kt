...
class InboundMailItemServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: InboundMailItemRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<InboundMailItem>> {
        ...
        override fun list(params: InboundMailItemListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<InboundMailItemListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
