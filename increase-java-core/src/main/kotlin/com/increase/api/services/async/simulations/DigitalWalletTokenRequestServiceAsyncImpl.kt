...
class DigitalWalletTokenRequestServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : DigitalWalletTokenRequestServiceAsync {
     ...
     * Apple Pay.
     */
    override fun create(params: SimulationDigitalWalletTokenRequestCreateParams, requestOptions: RequestOptions): CompletableFuture<SimulationDigitalWalletTokenRequestCreateResponse> {
