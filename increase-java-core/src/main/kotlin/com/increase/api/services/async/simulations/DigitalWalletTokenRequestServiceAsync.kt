...
interface DigitalWalletTokenRequestServiceAsync {
     ...
     */
    @JvmOverloads
    fun create(params: SimulationDigitalWalletTokenRequestCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<SimulationDigitalWalletTokenRequestCreateResponse>
}
