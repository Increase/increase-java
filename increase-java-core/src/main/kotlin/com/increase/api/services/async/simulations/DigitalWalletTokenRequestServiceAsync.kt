...
interface DigitalWalletTokenRequestServiceAsync {
     ...
     */
    @JvmOverloads
    fun create(params: SimulationsDigitalWalletTokenRequestCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<DigitalWalletTokenRequestCreateResponse>
}
