...
class BookkeepingEntrySetRetrieveParams constructor(private val bookkeepingEntrySetId: String, private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
    ...
    override fun toString() = "BookkeepingEntrySetRetrieveParams{bookkeepingEntrySetId=$bookkeepingEntrySetId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
