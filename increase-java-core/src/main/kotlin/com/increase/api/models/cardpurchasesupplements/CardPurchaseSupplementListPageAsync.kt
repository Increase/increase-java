...
class CardPurchaseSupplementListPageAsync private constructor(
    ...
    class AutoPager(
        ...
        fun forEach(action: Predicate<CardPurchaseSupplement>, executor: Executor): CompletableFuture<Void> {
          fun CompletableFuture<Optional<CardPurchaseSupplementListPageAsync>>.forEach(action: (CardPurchaseSupplement) -> Boolean, executor: Executor): CompletableFuture<Void> =
              thenComposeAsync(
                { page ->
                    page
                    .filter {
