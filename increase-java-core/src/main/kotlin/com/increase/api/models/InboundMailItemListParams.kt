...
class InboundMailItemListParams constructor(
  ...
  private val additionalHeaders: Map<String, List<String>>,
    ...
    override fun toString() = "InboundMailItemListParams{createdAt=$createdAt, cursor=$cursor, limit=$limit, lockboxId=$lockboxId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
