...
class WireTransfer @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** The message that will show on the recipient's bank statement. */
        fun messageToRecipient(messageToRecipient: Optional<String>) = messageToRecipient(messageToRecipient.getOrNull())
        ...
        /** The Account Number that was passed to the wire's recipient. */
        fun sourceAccountNumberId(sourceAccountNumberId: Optional<String>) = sourceAccountNumberId(sourceAccountNumberId.getOrNull())
    ...
    class Reversal @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** Additional financial institution information included in the wire reversal. */
            fun financialInstitutionToFinancialInstitutionInformation(financialInstitutionToFinancialInstitutionInformation: Optional<String>) = financialInstitutionToFinancialInstitutionInformation(financialInstitutionToFinancialInstitutionInformation.getOrNull())
             ...
             * institution.
             */
            fun receiverFinancialInstitutionInformation(receiverFinancialInstitutionInformation: Optional<String>) = receiverFinancialInstitutionInformation(receiverFinancialInstitutionInformation.getOrNull())
