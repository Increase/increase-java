...
class SupplementalDocumentListPageAsync private constructor(
    ...
    class AutoPager(
        ...
        fun forEach(action: Predicate<EntitySupplementalDocument>, executor: Executor): CompletableFuture<Void> {
          fun CompletableFuture<Optional<SupplementalDocumentListPageAsync>>.forEach(action: (EntitySupplementalDocument) -> Boolean, executor: Executor): CompletableFuture<Void> =
              thenComposeAsync(
                { page ->
                    page
                    .filter {
