...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.balanceCheck] with `balanceCheck.orElse(null)`. */
        fun balanceCheck(balanceCheck: Optional<BalanceCheck>) =
            balanceCheck(balanceCheck.getOrNull())
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /**
             * Alias for calling [Builder.physicalCheckBatchId] with
             * `physicalCheckBatchId.orElse(null)`.
             */
            fun physicalCheckBatchId(physicalCheckBatchId: Optional<String>) =
                physicalCheckBatchId(physicalCheckBatchId.getOrNull())
        ...
        private constructor(
             ...
             *   if the server responded with an unexpected value).
             */
            fun imageFileId(): Optional<String> = imageFileId.getOptional("image_file_id")
            ...
            class Builder internal constructor() {
                ...
                /** Alias for calling [Builder.imageFileId] with `imageFileId.orElse(null)`. */
                fun imageFileId(imageFileId: Optional<String>) =
                    imageFileId(imageFileId.getOrNull())
            ...
            @JvmSynthetic
            internal fun validity(): Int =
                (if (imageFileId.asKnown().isPresent) 1 else 0) +
        ...
        private constructor(
            ...
            class Category @JsonCreator private constructor(private val value: JsonField<String>) :
                ...
                companion object {
                    ...
                    @JvmField val RETURNING_TO_SENDER = of("returning_to_sender")
    ...
    class Status @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val PENDING_BATCH_COMPLETING = of("pending_batch_completing")
