...
class CheckTransferCreateParams private constructor(
    ...
    class PhysicalCheck @JsonCreator private constructor(
        ...
        override fun toString() = "PhysicalCheck{mailingAddress=$mailingAddress, memo=$memo, recipientName=$recipientName, note=$note, returnAddress=$returnAddress, signatureText=$signatureText, additionalProperties=$additionalProperties}"
    }
