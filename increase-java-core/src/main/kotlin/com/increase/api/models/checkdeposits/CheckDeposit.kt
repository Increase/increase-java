...
class CheckDeposit @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
         ...
         * contain details of the parsed check.
         */
        fun depositAcceptance(depositAcceptance: Optional<DepositAcceptance>) = depositAcceptance(depositAcceptance.getOrNull())
         ...
         * was rejected.
         */
        fun depositRejection(depositRejection: Optional<DepositRejection>) = depositRejection(depositRejection.getOrNull())
         ...
         * returned.
         */
        fun depositReturn(depositReturn: Optional<DepositReturn>) = depositReturn(depositReturn.getOrNull())
         ...
         * processing. This will contain details of the submission.
         */
        fun depositSubmission(depositSubmission: Optional<DepositSubmission>) = depositSubmission(depositSubmission.getOrNull())
         ...
         * the identifier of the Inbound Mail Item.
         */
        fun inboundMailItemId(inboundMailItemId: Optional<String>) = inboundMailItemId(inboundMailItemId.getOrNull())
    ...
    class DepositAcceptance @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
             ...
             * the serial number is usually in the `auxiliary_on_us` field.
             */
            fun serialNumber(serialNumber: Optional<String>) = serialNumber(serialNumber.getOrNull())
