...
class InboundWireTransferCreateParams private constructor(
     ...
     * value here.
     */
    fun beneficiaryName(): Optional<String> = body.beneficiaryName()

    /**
     * The sending bank will set beneficiary_reference in production. You can simulate
     * any value here.
     */
    fun beneficiaryReference(): Optional<String> = body.beneficiaryReference()
     ...
     * simulate any value here.
     */
    fun originatorRoutingNumber(): Optional<String> = body.originatorRoutingNumber()

    /**
     * The sending bank will set originator_to_beneficiary_information_line1 in
     * production. You can simulate any value here.
     */
    fun originatorToBeneficiaryInformationLine1(): Optional<String> = body.originatorToBeneficiaryInformationLine1()

    /**
     * The sending bank will set originator_to_beneficiary_information_line2 in
     * production. You can simulate any value here.
     */
    fun originatorToBeneficiaryInformationLine2(): Optional<String> = body.originatorToBeneficiaryInformationLine2()

    /**
     * The sending bank will set originator_to_beneficiary_information_line3 in
     * production. You can simulate any value here.
     */
    fun originatorToBeneficiaryInformationLine3(): Optional<String> = body.originatorToBeneficiaryInformationLine3()

    /**
     * The sending bank will set originator_to_beneficiary_information_line4 in
     * production. You can simulate any value here.
     */
    fun originatorToBeneficiaryInformationLine4(): Optional<String> = body.originatorToBeneficiaryInformationLine4()
