...
class AchTransferCreateParams private constructor(
     ...
     * sent.
     */
    fun destinationAccountHolder(): Optional<DestinationAccountHolder> = body.destinationAccountHolder()
    ...
    class Body @JsonCreator private constructor(
         ...
         * sent.
         */
        fun destinationAccountHolder(): Optional<DestinationAccountHolder> = Optional.ofNullable(destinationAccountHolder.getNullable("destination_account_holder"))
         ...
         * must be set.
         */
        fun preferredEffectiveDate(): Optional<PreferredEffectiveDate> = Optional.ofNullable(preferredEffectiveDate.getNullable("preferred_effective_date"))
        ...
        /** The Standard Entry Class (SEC) code to use for the transfer. */
        fun standardEntryClassCode(): Optional<StandardEntryClassCode> = Optional.ofNullable(standardEntryClassCode.getNullable("standard_entry_class_code"))

        /** The timing of the transaction. */
        fun transactionTiming(): Optional<TransactionTiming> = Optional.ofNullable(transactionTiming.getNullable("transaction_timing"))
        ...
        fun validate(): Body =
            apply {
                ...
                individualId()
                individualName()
                preferredEffectiveDate().ifPresent { it.validate() }
                requireApproval()
                routingNumber()
