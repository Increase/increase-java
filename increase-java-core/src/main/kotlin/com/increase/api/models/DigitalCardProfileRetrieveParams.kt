...
class DigitalCardProfileRetrieveParams constructor(private val digitalCardProfileId: String, private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
    ...
    override fun toString() = "DigitalCardProfileRetrieveParams{digitalCardProfileId=$digitalCardProfileId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
