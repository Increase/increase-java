...
class RoutingNumberListPageAsync private constructor(private val routingNumbersService: RoutingNumberServiceAsync, private val params: RoutingNumberListParams, private val response: Response, ) {
    ...
    class Response constructor(private val data: JsonField<List<RoutingNumberListResponse>>, private val nextCursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        @JsonProperty("data")
        fun _data(): Optional<JsonField<List<RoutingNumberListResponse>>> = Optional.ofNullable(data)
    ...
    class AutoPager constructor(private val firstPage: RoutingNumberListPageAsync, ) {
        ...
        fun forEach(action: Predicate<RoutingNumberListResponse>, executor: Executor): CompletableFuture<Void> {
          fun CompletableFuture<Optional<RoutingNumberListPageAsync>>.forEach(action: (RoutingNumberListResponse) -> Boolean, executor: Executor): CompletableFuture<Void> = thenComposeAsync({ page -> 
              page
              .filter {
                  it.data().all(action)
              }
