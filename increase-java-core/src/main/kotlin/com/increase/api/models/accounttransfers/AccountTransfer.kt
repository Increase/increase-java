...
class AccountTransfer @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** The ID for the transaction receiving the transfer. */
        fun destinationTransactionId(destinationTransactionId: Optional<String>) = destinationTransactionId(destinationTransactionId.getOrNull())
    ...
    class Type @JsonCreator private constructor(
        ...
        companion object {
            ...
            @JvmField val ACCOUNT_TRANSFER = of("account_transfer")
