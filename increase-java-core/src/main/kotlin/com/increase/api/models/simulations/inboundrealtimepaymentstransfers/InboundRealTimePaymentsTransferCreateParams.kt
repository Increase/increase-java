...
class InboundRealTimePaymentsTransferCreateParams private constructor(
    ...
    fun requestForPaymentId(): Optional<String> = body.requestForPaymentId()
    ...
    class Body @JsonCreator private constructor(
        ...
        /** The account number of the account that sent the transfer. */
        fun debtorAccountNumber(): Optional<String> = Optional.ofNullable(debtorAccountNumber.getNullable("debtor_account_number"))

        /** The name provided by the sender of the transfer. */
        fun debtorName(): Optional<String> = Optional.ofNullable(debtorName.getNullable("debtor_name"))

        /** The routing number of the account that sent the transfer. */
        fun debtorRoutingNumber(): Optional<String> = Optional.ofNullable(debtorRoutingNumber.getNullable("debtor_routing_number"))

        /** Additional information included with the transfer. */
        fun remittanceInformation(): Optional<String> = Optional.ofNullable(remittanceInformation.getNullable("remittance_information"))

        /** The identifier of a pending Request for Payment that this transfer will fulfill. */
        fun requestForPaymentId(): Optional<String> = Optional.ofNullable(requestForPaymentId.getNullable("request_for_payment_id"))
