...
class ExternalAccountRetrieveParams constructor(private val externalAccountId: String,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    override fun toString() = "ExternalAccountRetrieveParams{externalAccountId=$externalAccountId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
