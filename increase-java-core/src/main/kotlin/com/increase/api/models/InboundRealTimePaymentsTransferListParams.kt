...
class InboundRealTimePaymentsTransferListParams constructor(
  ...
  private val additionalHeaders: Map<String, List<String>>,
    ...
    override fun toString() = "InboundRealTimePaymentsTransferListParams{accountId=$accountId, accountNumberId=$accountNumberId, createdAt=$createdAt, cursor=$cursor, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(inboundRealTimePaymentsTransferListParams: InboundRealTimePaymentsTransferListParams) = apply {
        ...
        fun build(): InboundRealTimePaymentsTransferListParams = InboundRealTimePaymentsTransferListParams(
            accountId,
            accountNumberId,
            createdAt,
            cursor,
