...
class CardProfileListParams constructor(private val cursor: String?,private val limit: Long?,private val status: Status?,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    override fun toString() = "CardProfileListParams{cursor=$cursor, limit=$limit, status=$status, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        fun build(): CardProfileListParams = CardProfileListParams(
            cursor,
            limit,
            status,
