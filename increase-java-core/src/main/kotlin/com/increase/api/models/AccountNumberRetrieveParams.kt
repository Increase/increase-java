...
class AccountNumberRetrieveParams constructor(private val accountNumberId: String, private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
    ...
    override fun toString() = "AccountNumberRetrieveParams{accountNumberId=$accountNumberId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
