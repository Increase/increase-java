...
class InterestPaymentCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        /** The end of the interest period. If not provided, defaults to the current time. */
        fun periodEnd(): Optional<OffsetDateTime> = Optional.ofNullable(periodEnd.getNullable("period_end"))

        /** The start of the interest period. If not provided, defaults to the current time. */
        fun periodStart(): Optional<OffsetDateTime> = Optional.ofNullable(periodStart.getNullable("period_start"))
