...
class CheckDepositRetrieveParams constructor(private val checkDepositId: String,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    override fun toString() = "CheckDepositRetrieveParams{checkDepositId=$checkDepositId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
