...
private constructor(
    ...
    fun entityBeneficialOwnerId(): Optional<String> = Optional.ofNullable(entityBeneficialOwnerId)
     ...
     *   server responded with an unexpected value).
     */
    fun prongs(): Optional<List<Prong>> = body.prongs()
    ...
    companion object {
        ...
        @JvmStatic fun none(): BeneficialOwnerUpdateParams = builder().build()
    ...
    class Builder internal constructor() {
         ...
         */
        fun entityBeneficialOwnerId(entityBeneficialOwnerId: Optional<String>) =
    ...
    private constructor(
         ...
         *   the server responded with an unexpected value).
         */
        fun prongs(): Optional<List<Prong>> = prongs.getOptional("prongs")
