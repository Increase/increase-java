...
class InboundRealTimePaymentsTransfer @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** If your transfer is confirmed, this will contain details of the confirmation. */
        fun confirmation(confirmation: Optional<Confirmation>) = confirmation(confirmation.getOrNull())
    ...
    class Type @JsonCreator private constructor(
        ...
        companion object {
            ...
            @JvmField val INBOUND_REAL_TIME_PAYMENTS_TRANSFER = of("inbound_real_time_payments_transfer")
