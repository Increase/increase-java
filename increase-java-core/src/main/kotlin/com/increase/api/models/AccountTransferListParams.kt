...
class AccountTransferListParams constructor(private val cursor: String?,private val limit: Long?,private val accountId: String?,private val createdAt: CreatedAt?,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    override fun toString() = "AccountTransferListParams{cursor=$cursor, limit=$limit, accountId=$accountId, createdAt=$createdAt, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
