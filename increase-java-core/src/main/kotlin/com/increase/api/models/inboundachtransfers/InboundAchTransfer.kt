...
class InboundAchTransfer @JsonCreator private constructor(
     ...
     */
    fun internationalAddenda(): Optional<InternationalAddenda> = Optional.ofNullable(internationalAddenda.getNullable("international_addenda"))
    ...
    class Builder internal constructor() {
         ...
         * contain fields pertaining to the International ACH Transaction.
         */
        fun internationalAddenda(internationalAddenda: Optional<InternationalAddenda>) = internationalAddenda(internationalAddenda.getOrNull())
         ...
         * contain its details.
         */
        fun notificationOfChange(notificationOfChange: Optional<NotificationOfChange>) = notificationOfChange(notificationOfChange.getOrNull())
        ...
        /** If your transfer is returned, this will contain details of the return. */
        fun transferReturn(transferReturn: Optional<TransferReturn>) = transferReturn(transferReturn.getOrNull())
    ...
    class InternationalAddenda @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
             ...
             * reference to a well-known rate.
             */
            fun foreignExchangeReference(foreignExchangeReference: Optional<String>) = foreignExchangeReference(foreignExchangeReference.getOrNull())
            ...
            /** A reference number in the foreign banking infrastructure. */
            fun foreignTraceNumber(foreignTraceNumber: Optional<String>) = foreignTraceNumber(foreignTraceNumber.getOrNull())
            ...
            /** A portion of the originator address. This may be incomplete. */
            fun originatorPostalCode(originatorPostalCode: Optional<String>) = originatorPostalCode(originatorPostalCode.getOrNull())
            ...
            /** A portion of the originator address. This may be incomplete. */
            fun originatorStateOrProvince(originatorStateOrProvince: Optional<String>) = originatorStateOrProvince(originatorStateOrProvince.getOrNull())
            ...
            /** A description field set by the originator. */
            fun paymentRelatedInformation(paymentRelatedInformation: Optional<String>) = paymentRelatedInformation(paymentRelatedInformation.getOrNull())
            ...
            /** A description field set by the originator. */
            fun paymentRelatedInformation2(paymentRelatedInformation2: Optional<String>) = paymentRelatedInformation2(paymentRelatedInformation2.getOrNull())
            ...
            /** An identification number the originator uses for the receiver. */
            fun receiverIdentificationNumber(receiverIdentificationNumber: Optional<String>) = receiverIdentificationNumber(receiverIdentificationNumber.getOrNull())
            ...
            /** A portion of the receiver address. This may be incomplete. */
            fun receiverPostalCode(receiverPostalCode: Optional<String>) = receiverPostalCode(receiverPostalCode.getOrNull())
            ...
            /** A portion of the receiver address. This may be incomplete. */
            fun receiverStateOrProvince(receiverStateOrProvince: Optional<String>) = receiverStateOrProvince(receiverStateOrProvince.getOrNull())
        ...
        class ForeignExchangeReferenceIndicator @JsonCreator private constructor(
            ...
            companion object {
                ...
                @JvmField val FOREIGN_EXCHANGE_REFERENCE_NUMBER = of("foreign_exchange_reference_number")
        ...
        class OriginatingDepositoryFinancialInstitutionIdQualifier @JsonCreator private constructor(
            ...
            companion object {
                 ...
                 */
                @JvmField val NATIONAL_CLEARING_SYSTEM_NUMBER = of("national_clearing_system_number")
    ...
    class NotificationOfChange @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** The new account number provided in the notification of change. */
            fun updatedAccountNumber(updatedAccountNumber: Optional<String>) = updatedAccountNumber(updatedAccountNumber.getOrNull())
            ...
            /** The new account number provided in the notification of change. */
            fun updatedRoutingNumber(updatedRoutingNumber: Optional<String>) = updatedRoutingNumber(updatedRoutingNumber.getOrNull())
