...
class IntrafiAccountEnrollmentRetrieveParams constructor(private val intrafiAccountEnrollmentId: String, private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
    ...
    override fun toString() = "IntrafiAccountEnrollmentRetrieveParams{intrafiAccountEnrollmentId=$intrafiAccountEnrollmentId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
