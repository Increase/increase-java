...
class RoutingNumberListParams constructor(private val cursor: String?,private val limit: Long?,private val routingNumber: String,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    override fun toString() = "RoutingNumberListParams{cursor=$cursor, limit=$limit, routingNumber=$routingNumber, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
