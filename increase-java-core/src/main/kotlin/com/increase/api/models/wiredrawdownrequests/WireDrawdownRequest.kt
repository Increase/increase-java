...
class WireDrawdownRequest @JsonCreator private constructor(
     ...
     */
    fun fulfillmentInboundWireTransferId(): Optional<String> = Optional.ofNullable(fulfillmentInboundWireTransferId.getNullable("fulfillment_inbound_wire_transfer_id"))
    ...
    class Builder internal constructor() {
         ...
         * be the identifier of the corresponding Transaction.
         */
        fun fulfillmentInboundWireTransferId(fulfillmentInboundWireTransferId: Optional<String>) = fulfillmentInboundWireTransferId(fulfillmentInboundWireTransferId.getOrNull())
        ...
        /** Line 1 of the drawdown request's recipient's address. */
        fun recipientAddressLine1(recipientAddressLine1: Optional<String>) = recipientAddressLine1(recipientAddressLine1.getOrNull())
        ...
        /** Line 2 of the drawdown request's recipient's address. */
        fun recipientAddressLine2(recipientAddressLine2: Optional<String>) = recipientAddressLine2(recipientAddressLine2.getOrNull())
        ...
        /** Line 3 of the drawdown request's recipient's address. */
        fun recipientAddressLine3(recipientAddressLine3: Optional<String>) = recipientAddressLine3(recipientAddressLine3.getOrNull())
