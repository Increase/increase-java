...
class BookkeepingEntrySetListParams constructor(
  ...
  private val additionalHeaders: Map<String, List<String>>,
    ...
    override fun toString() = "BookkeepingEntrySetListParams{cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, transactionId=$transactionId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
