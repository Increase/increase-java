...
class RealTimeDecisionActionParams private constructor(
     ...
     */
    fun cardAuthenticationChallenge(): Optional<CardAuthenticationChallenge> = body.cardAuthenticationChallenge()
     ...
     */
    fun digitalWalletAuthentication(): Optional<DigitalWalletAuthentication> = body.digitalWalletAuthentication()
