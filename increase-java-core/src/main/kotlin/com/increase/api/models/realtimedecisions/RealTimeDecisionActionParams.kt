...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun cardBalanceInquiry(): Optional<CardBalanceInquiry> = body.cardBalanceInquiry()
    ...
    private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (decision.asKnown().getOrNull()?.validity() ?: 0)
    ...
    private constructor(
        ...
        private constructor(
            ...
            fun cardholderAddressVerificationResult():
                Optional<CardholderAddressVerificationResult> =
    ...
    private constructor(
         ...
         *   the server responded with an unexpected value).
         */
        fun success(): Optional<Success> = success.getOptional("success")
