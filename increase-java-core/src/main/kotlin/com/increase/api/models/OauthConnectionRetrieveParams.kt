...
class OauthConnectionRetrieveParams constructor(private val oauthConnectionId: String,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    override fun toString() = "OauthConnectionRetrieveParams{oauthConnectionId=$oauthConnectionId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
