...
class RealTimePaymentsTransfer @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
         ...
         * an intermediary receiving the payment for someone else.
         */
        fun ultimateCreditorName(ultimateCreditorName: Optional<String>) = ultimateCreditorName(ultimateCreditorName.getOrNull())
         ...
         * sent on behalf of someone who is not the account holder at Increase.
         */
        fun ultimateDebtorName(ultimateDebtorName: Optional<String>) = ultimateDebtorName(ultimateDebtorName.getOrNull())
    ...
    class Rejection @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
             ...
             * the `reject_reason_code` is `NARRATIVE`.
             */
            fun rejectReasonAdditionalInformation(rejectReasonAdditionalInformation: Optional<String>) = rejectReasonAdditionalInformation(rejectReasonAdditionalInformation.getOrNull())
        ...
        class RejectReasonCode @JsonCreator private constructor(
            ...
            companion object {
                 ...
                 * reason code `AC03`.
                 */
                @JvmField val INVALID_CREDITOR_ACCOUNT_NUMBER = of("invalid_creditor_account_number")

                /**
                 * The destination routing number is invalid. Corresponds to the Real-Time Payments
                 * reason code `RC04`.
                 */
                @JvmField val INVALID_CREDITOR_FINANCIAL_INSTITUTION_IDENTIFIER = of("invalid_creditor_financial_institution_identifier")
                 ...
                 */
                @JvmField val UNSUPPORTED_MESSAGE_FOR_RECIPIENT = of("unsupported_message_for_recipient")
                 ...
                 */
                @JvmField val RECIPIENT_CONNECTION_NOT_AVAILABLE = of("recipient_connection_not_available")
    ...
    class Submission @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
             ...
             * the transfer was submitted to The Clearing House.
             */
            fun submittedAt(submittedAt: Optional<OffsetDateTime>) = submittedAt(submittedAt.getOrNull())
