...
constructor(
     ...
     */
    fun productionToken(): Optional<String> = body.productionToken()
    ...
    @JvmSynthetic internal fun getBody(): OAuthTokenCreateBody = body
    ...
    internal constructor(
        ...
        /** The authorization code generated by the user and given to you as a query parameter. */
        @JsonProperty("code") fun code(): Optional<String> = Optional.ofNullable(code)
        ...
        class Builder {
             ...
             * in Sandbox. Set `grant_type` to `production_token` to use this parameter.
             */
            fun productionToken(productionToken: Optional<String>) =
                productionToken(productionToken.orElse(null))
