...
class IntrafiExclusionRetrieveParams constructor(private val intrafiExclusionId: String, private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
    ...
    override fun toString() = "IntrafiExclusionRetrieveParams{intrafiExclusionId=$intrafiExclusionId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
