...
class Card @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
         ...
         * steps.
         */
        fun digitalWallet(digitalWallet: Optional<DigitalWallet>) = digitalWallet(digitalWallet.getOrNull())
    ...
    class DigitalWallet @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
             ...
             * be assigned at the program level.
             */
            fun digitalCardProfileId(digitalCardProfileId: Optional<String>) = digitalCardProfileId(digitalCardProfileId.getOrNull())
