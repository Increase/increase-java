...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun networkDetails(): Optional<NetworkDetails> = body.networkDetails()
     ...
     *   server responded with an unexpected value).
     */
    fun networkRiskScore(): Optional<Long> = body.networkRiskScore()
     ...
     *   server responded with an unexpected value).
     */
    fun processingCategory(): Optional<ProcessingCategory> = body.processingCategory()
    ...
    private constructor(
         ...
         *   the server responded with an unexpected value).
         */
        fun processingCategory(): Optional<ProcessingCategory> =
            processingCategory.getOptional("processing_category")
        ...
        fun validate(): Body = apply {
            ...
            networkRiskScore()
            physicalCardId()
            processingCategory().ifPresent { it.validate() }
            terminalId()
            validated = true
        }
        ...
        internal fun validity(): Int =
            (if (amount.asKnown().isPresent) 1 else 0) +
                (if (authenticatedCardPaymentId.asKnown().isPresent) 1 else 0) +
        ...
        private constructor(
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                companion object {
                    ...
                    @JvmStatic fun of(value: String) = TerminalEntryCapability(JsonField.of(value))
                }
    ...
    private constructor(
         ...
         *   the server responded with an unexpected value).
         */
        fun refund(): Optional<Refund> = refund.getOptional("refund")
        ...
        internal fun validity(): Int =
            (category.asKnown().getOrNull()?.validity() ?: 0) +
                (refund.asKnown().getOrNull()?.validity() ?: 0)
        ...
        private constructor(
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (originalCardPaymentId.asKnown().isPresent) 1 else 0)
