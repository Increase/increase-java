...
class CardAuthorizationCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
         ...
         * simulate an authenticated authorization.
         */
        fun authenticatedCardPaymentId(): Optional<String> = Optional.ofNullable(authenticatedCardPaymentId.getNullable("authenticated_card_payment_id"))
         ...
         * specified event subscription for testing purposes.
         */
        fun eventSubscriptionId(): Optional<String> = Optional.ofNullable(eventSubscriptionId.getNullable("event_subscription_id"))
        ...
        /** The merchant descriptor of the merchant the card is transacting with. */
        fun merchantDescriptor(): Optional<String> = Optional.ofNullable(merchantDescriptor.getNullable("merchant_descriptor"))

        /** The state the merchant resides in. */
        fun merchantState(): Optional<String> = Optional.ofNullable(merchantState.getNullable("merchant_state"))

        /** Fields specific to a given card network. */
        fun networkDetails(): Optional<NetworkDetails> = Optional.ofNullable(networkDetails.getNullable("network_details"))
