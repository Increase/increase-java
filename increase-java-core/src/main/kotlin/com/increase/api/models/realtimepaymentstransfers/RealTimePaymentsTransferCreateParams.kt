...
class RealTimePaymentsTransferCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        /** The destination account number. */
        fun destinationAccountNumber(): Optional<String> = Optional.ofNullable(destinationAccountNumber.getNullable("destination_account_number"))

        /**
         * The destination American Bankers' Association (ABA) Routing Transit Number
         * (RTN).
         */
        fun destinationRoutingNumber(): Optional<String> = Optional.ofNullable(destinationRoutingNumber.getNullable("destination_routing_number"))
