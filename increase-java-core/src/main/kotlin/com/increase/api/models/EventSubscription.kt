...
@NoAutoDetect
class EventSubscription private constructor(private val id: JsonField<String>,private val createdAt: JsonField<OffsetDateTime>,private val status: JsonField<Status>,private val selectedEventCategory: JsonField<SelectedEventCategory>,private val url: JsonField<String>,private val sharedSecret: JsonField<String>,private val type: JsonField<Type>,private val additionalProperties: Map<String, JsonValue>,) {
    ...
    @ExcludeMissing
    fun _sharedSecret() = sharedSecret
    ...
    override fun toString() = "EventSubscription{id=$id, createdAt=$createdAt, status=$status, selectedEventCategory=$selectedEventCategory, url=$url, sharedSecret=$sharedSecret, type=$type, additionalProperties=$additionalProperties}"
