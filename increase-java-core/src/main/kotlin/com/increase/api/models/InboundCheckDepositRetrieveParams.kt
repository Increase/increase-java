...
class InboundCheckDepositRetrieveParams constructor(private val inboundCheckDepositId: String, private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
    ...
    override fun toString() = "InboundCheckDepositRetrieveParams{inboundCheckDepositId=$inboundCheckDepositId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
