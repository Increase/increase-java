...
class DigitalWalletTokenListParams constructor(private val cursor: String?,private val limit: Long?,private val cardId: String?,private val createdAt: CreatedAt?,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    override fun toString() = "DigitalWalletTokenListParams{cursor=$cursor, limit=$limit, cardId=$cardId, createdAt=$createdAt, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
