...
class ProofOfAuthorizationRequestSubmissionListPageAsync private constructor(
    ...
    class AutoPager(
        ...
        fun forEach(action: Predicate<ProofOfAuthorizationRequestSubmission>, executor: Executor): CompletableFuture<Void> {
          fun CompletableFuture<Optional<ProofOfAuthorizationRequestSubmissionListPageAsync>>.forEach(action: (ProofOfAuthorizationRequestSubmission) -> Boolean, executor: Executor): CompletableFuture<Void> =
              thenComposeAsync(
                { page ->
                    page
                    .filter {
