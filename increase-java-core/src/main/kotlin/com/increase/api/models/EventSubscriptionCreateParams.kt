  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    class SelectedEventCategory @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        companion object {
            ...
            @JvmField val INBOUND_REAL_TIME_PAYMENTS_TRANSFER_CREATED = SelectedEventCategory(JsonField.of("inbound_real_time_payments_transfer.created"))

            @JvmField val INBOUND_REAL_TIME_PAYMENTS_TRANSFER_UPDATED = SelectedEventCategory(JsonField.of("inbound_real_time_payments_transfer.updated"))
