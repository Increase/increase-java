...
class EventSubscriptionCreateParams constructor(private val url: String,private val sharedSecret: String?,private val selectedEventCategory: SelectedEventCategory?,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,private val additionalBodyProperties: Map<String, JsonValue>,) {
    ...
    @NoAutoDetect
    class EventSubscriptionCreateBody internal constructor(private val url: String?,private val sharedSecret: String?,private val selectedEventCategory: SelectedEventCategory?,private val additionalProperties: Map<String, JsonValue>,) {
        ...
        override fun toString() = "EventSubscriptionCreateBody{url=$url, sharedSecret=$sharedSecret, selectedEventCategory=$selectedEventCategory, additionalProperties=$additionalProperties}"
    ...
    override fun toString() = "EventSubscriptionCreateParams{url=$url, sharedSecret=$sharedSecret, selectedEventCategory=$selectedEventCategory, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class SelectedEventCategory @JsonCreator private constructor(private val value: JsonField<String>,) {
