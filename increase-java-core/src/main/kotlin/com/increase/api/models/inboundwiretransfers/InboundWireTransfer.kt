...
class InboundWireTransfer @JsonCreator private constructor(
    ...
    fun senderReference(): Optional<String> = Optional.ofNullable(senderReference.getNullable("sender_reference"))
    ...
    class Builder internal constructor() {
        ...
        /** A free-form address field set by the sender. */
        fun beneficiaryAddressLine1(beneficiaryAddressLine1: Optional<String>) = beneficiaryAddressLine1(beneficiaryAddressLine1.getOrNull())
        ...
        /** A free-form address field set by the sender. */
        fun beneficiaryAddressLine2(beneficiaryAddressLine2: Optional<String>) = beneficiaryAddressLine2(beneficiaryAddressLine2.getOrNull())
        ...
        /** A free-form address field set by the sender. */
        fun beneficiaryAddressLine3(beneficiaryAddressLine3: Optional<String>) = beneficiaryAddressLine3(beneficiaryAddressLine3.getOrNull())
        ...
        /** A name set by the sender. */
        fun beneficiaryName(beneficiaryName: Optional<String>) = beneficiaryName(beneficiaryName.getOrNull())
        ...
        /** A free-form reference string set by the sender, to help identify the transfer. */
        fun beneficiaryReference(beneficiaryReference: Optional<String>) = beneficiaryReference(beneficiaryReference.getOrNull())
         ...
         * service and is helpful when debugging wires with the originating bank.
         */
        fun inputMessageAccountabilityData(inputMessageAccountabilityData: Optional<String>) = inputMessageAccountabilityData(inputMessageAccountabilityData.getOrNull())
        ...
        /** The address of the wire originator, set by the sending bank. */
        fun originatorAddressLine1(originatorAddressLine1: Optional<String>) = originatorAddressLine1(originatorAddressLine1.getOrNull())
        ...
        /** The address of the wire originator, set by the sending bank. */
        fun originatorAddressLine2(originatorAddressLine2: Optional<String>) = originatorAddressLine2(originatorAddressLine2.getOrNull())
        ...
        /** The address of the wire originator, set by the sending bank. */
        fun originatorAddressLine3(originatorAddressLine3: Optional<String>) = originatorAddressLine3(originatorAddressLine3.getOrNull())
        ...
        /** The originator of the wire, set by the sending bank. */
        fun originatorName(originatorName: Optional<String>) = originatorName(originatorName.getOrNull())
         ...
         * the transfer.
         */
        fun originatorRoutingNumber(originatorRoutingNumber: Optional<String>) = originatorRoutingNumber(originatorRoutingNumber.getOrNull())
        ...
        /** An Increase-created concatenation of the Originator-to-Beneficiary lines. */
        fun originatorToBeneficiaryInformation(originatorToBeneficiaryInformation: Optional<String>) = originatorToBeneficiaryInformation(originatorToBeneficiaryInformation.getOrNull())
        ...
        /** A free-form message set by the wire originator. */
        fun originatorToBeneficiaryInformationLine1(originatorToBeneficiaryInformationLine1: Optional<String>) = originatorToBeneficiaryInformationLine1(originatorToBeneficiaryInformationLine1.getOrNull())
        ...
        /** A free-form message set by the wire originator. */
        fun originatorToBeneficiaryInformationLine2(originatorToBeneficiaryInformationLine2: Optional<String>) = originatorToBeneficiaryInformationLine2(originatorToBeneficiaryInformationLine2.getOrNull())
        ...
        /** A free-form message set by the wire originator. */
        fun originatorToBeneficiaryInformationLine3(originatorToBeneficiaryInformationLine3: Optional<String>) = originatorToBeneficiaryInformationLine3(originatorToBeneficiaryInformationLine3.getOrNull())
        ...
        /** A free-form message set by the wire originator. */
        fun originatorToBeneficiaryInformationLine4(originatorToBeneficiaryInformationLine4: Optional<String>) = originatorToBeneficiaryInformationLine4(originatorToBeneficiaryInformationLine4.getOrNull())
        ...
        /** The sending bank's reference number for the wire transfer. */
        fun senderReference(senderReference: Optional<String>) = senderReference(senderReference.getOrNull())
