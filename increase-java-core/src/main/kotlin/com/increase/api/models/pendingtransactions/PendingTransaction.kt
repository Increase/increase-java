...
class PendingTransaction @JsonCreator private constructor(
    ...
    class Source @JsonCreator private constructor(
         ...
         */
        fun inboundWireTransferReversal(): Optional<InboundWireTransferReversal> = Optional.ofNullable(inboundWireTransferReversal.getNullable("inbound_wire_transfer_reversal"))
        ...
        class Builder internal constructor() {
             ...
             * response if and only if `category` is equal to `account_transfer_instruction`.
             */
            fun accountTransferInstruction(accountTransferInstruction: Optional<AccountTransferInstruction>) = accountTransferInstruction(accountTransferInstruction.getOrNull())
             ...
             * response if and only if `category` is equal to `ach_transfer_instruction`.
             */
            fun achTransferInstruction(achTransferInstruction: Optional<AchTransferInstruction>) = achTransferInstruction(achTransferInstruction.getOrNull())
             ...
             * transaction.
             */
            fun cardAuthorization(cardAuthorization: Optional<CardAuthorization>) = cardAuthorization(cardAuthorization.getOrNull())
             ...
             * response if and only if `category` is equal to `check_deposit_instruction`.
             */
            fun checkDepositInstruction(checkDepositInstruction: Optional<CheckDepositInstruction>) = checkDepositInstruction(checkDepositInstruction.getOrNull())
             ...
             * response if and only if `category` is equal to `check_transfer_instruction`.
             */
            fun checkTransferInstruction(checkTransferInstruction: Optional<CheckTransferInstruction>) = checkTransferInstruction(checkTransferInstruction.getOrNull())
             ...
             * be clawed back by the sending institution.
             */
            fun inboundFundsHold(inboundFundsHold: Optional<InboundFundsHold>) = inboundFundsHold(inboundFundsHold.getOrNull())
             ...
             * and the User requests that it be reversed.
             */
            fun inboundWireTransferReversal(inboundWireTransferReversal: Optional<InboundWireTransferReversal>) = inboundWireTransferReversal(inboundWireTransferReversal.getOrNull())
             ...
             * `real_time_payments_transfer_instruction`.
             */
            fun realTimePaymentsTransferInstruction(realTimePaymentsTransferInstruction: Optional<RealTimePaymentsTransferInstruction>) = realTimePaymentsTransferInstruction(realTimePaymentsTransferInstruction.getOrNull())
             ...
             * response if and only if `category` is equal to `wire_transfer_instruction`.
             */
            fun wireTransferInstruction(wireTransferInstruction: Optional<WireTransferInstruction>) = wireTransferInstruction(wireTransferInstruction.getOrNull())
        ...
        class Category @JsonCreator private constructor(
            ...
            companion object {
                 ...
                 */
                @JvmField val REAL_TIME_PAYMENTS_TRANSFER_INSTRUCTION = of("real_time_payments_transfer_instruction")
        ...
        class CheckDepositInstruction @JsonCreator private constructor(
            ...
            class Builder internal constructor() {
                ...
                /** The identifier of the Check Deposit. */
                fun checkDepositId(checkDepositId: Optional<String>) = checkDepositId(checkDepositId.getOrNull())
