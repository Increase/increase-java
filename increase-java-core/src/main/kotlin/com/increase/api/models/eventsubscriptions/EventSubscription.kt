...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun selectedEventCategories(): Optional<List<SelectedEventCategory>> =
    ...
    class Builder internal constructor() {
        ...
        fun selectedEventCategories(
            selectedEventCategories: Optional<List<SelectedEventCategory>>
        ) = selectedEventCategories(selectedEventCategories.getOrNull())
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (selectedEventCategories.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    private constructor(
         ...
         */
        fun eventCategory(): Optional<EventCategory> = eventCategory.getOptional("event_category")
        ...
        class Builder internal constructor() {
            ...
            /** Alias for calling [Builder.eventCategory] with `eventCategory.orElse(null)`. */
            fun eventCategory(eventCategory: Optional<EventCategory>) =
                eventCategory(eventCategory.getOrNull())
        ...
        fun validate(): SelectedEventCategory = apply {
            ...
            eventCategory().ifPresent { it.validate() }
            validated = true
        }
        ...
        class EventCategory @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField val LOAN_APPLICATION_CREATED = of("loan_application.created")
                ...
                @JvmField val LOAN_OBLIGATION_CREATED = of("loan_obligation.created")
                ...
                @JvmField val CHECKBOOK_UPDATED = of("checkbook.updated")
                ...
                @JvmField val SEPA_INSTANT_TRANSFER_CREATED = of("sepa_instant_transfer.created")

                /** Occurs whenever a SEPA Instant Transfer is updated. */
                @JvmField val SEPA_INSTANT_TRANSFER_UPDATED = of("sepa_instant_transfer.updated")
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val EVENT_SUBSCRIPTION = of("event_subscription")
