...
class InboundWireDrawdownRequestListPageAsync private constructor(
    ...
    class AutoPager(
        ...
        fun forEach(action: Predicate<InboundWireDrawdownRequest>, executor: Executor): CompletableFuture<Void> {
          fun CompletableFuture<Optional<InboundWireDrawdownRequestListPageAsync>>.forEach(action: (InboundWireDrawdownRequest) -> Boolean, executor: Executor): CompletableFuture<Void> =
              thenComposeAsync(
                { page ->
                    page
                    .filter {
