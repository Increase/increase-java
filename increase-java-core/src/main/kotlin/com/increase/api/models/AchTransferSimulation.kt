...
@NoAutoDetect
class AchTransferSimulation private constructor(private val transaction: JsonField<Transaction>,private val declinedTransaction: JsonField<DeclinedTransaction>,private val type: JsonField<Type>,private val additionalProperties: Map<String, JsonValue>,) {
    ...
    override fun toString() = "AchTransferSimulation{transaction=$transaction, declinedTransaction=$declinedTransaction, type=$type, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        fun build(): AchTransferSimulation = AchTransferSimulation(
            transaction,
            declinedTransaction,
            type,
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>,) {
        ...
        companion object {
            ...
            @JvmField val INBOUND_ACH_TRANSFER_SIMULATION_RESULT = Type(JsonField.of("inbound_ach_transfer_simulation_result"))
        ...
        fun value(): Value = when (this) {
            INBOUND_ACH_TRANSFER_SIMULATION_RESULT -> Value.INBOUND_ACH_TRANSFER_SIMULATION_RESULT
            else -> Value._UNKNOWN
        }

        fun known(): Known = when (this) {
            INBOUND_ACH_TRANSFER_SIMULATION_RESULT -> Known.INBOUND_ACH_TRANSFER_SIMULATION_RESULT
            else -> throw IncreaseInvalidDataException("Unknown Type: $value")
        }
