...
@NoAutoDetect
class File private constructor(private val createdAt: JsonField<OffsetDateTime>,private val id: JsonField<String>,private val purpose: JsonField<Purpose>,private val description: JsonField<String>,private val direction: JsonField<Direction>,private val filename: JsonField<String>,private val downloadUrl: JsonField<String>,private val type: JsonField<Type>,private val additionalProperties: Map<String, JsonValue>,) {
    ...
    override fun toString() = "File{createdAt=$createdAt, id=$id, purpose=$purpose, description=$description, direction=$direction, filename=$filename, downloadUrl=$downloadUrl, type=$type, additionalProperties=$additionalProperties}"
