...
private constructor(
    ...
    fun cardTokenId(): Optional<String> = Optional.ofNullable(cardTokenId)
    ...
    companion object {
        ...
        @JvmStatic fun none(): CardTokenCapabilitiesParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.cardTokenId] with `cardTokenId.orElse(null)`. */
        fun cardTokenId(cardTokenId: Optional<String>) = cardTokenId(cardTokenId.getOrNull())
