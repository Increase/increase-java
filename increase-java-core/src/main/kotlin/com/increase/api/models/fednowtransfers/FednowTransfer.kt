...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun creditorAddress(): Optional<CreditorAddress> =
     ...
     *   server responded with an unexpected value).
     */
    fun debtorAddress(): Optional<DebtorAddress> = debtorAddress.getOptional("debtor_address")
    ...
    class Builder internal constructor() {
        ...
        fun creditorAddress(creditorAddress: Optional<CreditorAddress>) =
        ...
        /** Alias for calling [Builder.debtorAddress] with `debtorAddress.orElse(null)`. */
        fun debtorAddress(debtorAddress: Optional<DebtorAddress>) =
            debtorAddress(debtorAddress.getOrNull())
    ...
    fun validate(): FednowTransfer = apply {
        ...
        creditorName()
        currency().validate()
        debtorAddress().ifPresent { it.validate() }
        debtorName()
        externalAccountId()
        idempotencyKey()
        pendingTransactionId()
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (returns.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    private constructor(
        ...
        fun rejectReasonAdditionalInformation(): Optional<String> =
            rejectReasonAdditionalInformation.getOptional("reject_reason_additional_information")
        ...
        class Builder internal constructor() {
            ...
            /**
             * Alias for calling [Builder.rejectReasonAdditionalInformation] with
             * `rejectReasonAdditionalInformation.orElse(null)`.
             */
        ...
        @JvmSynthetic
        internal fun validity(): Int =
            (if (rejectReasonAdditionalInformation.asKnown().isPresent) 1 else 0) +
                (rejectReasonCode.asKnown().getOrNull()?.validity() ?: 0) +
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val FEDNOW_TRANSFER = of("fednow_transfer")
