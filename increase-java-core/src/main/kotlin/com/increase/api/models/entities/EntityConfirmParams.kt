...
class EntityConfirmParams private constructor(
     ...
     * will be used.
     */
    fun confirmedAt(): Optional<OffsetDateTime> = body.confirmedAt()
    ...
    class Body @JsonCreator private constructor(
         ...
         * will be used.
         */
        fun confirmedAt(): Optional<OffsetDateTime> = Optional.ofNullable(confirmedAt.getNullable("confirmed_at"))
