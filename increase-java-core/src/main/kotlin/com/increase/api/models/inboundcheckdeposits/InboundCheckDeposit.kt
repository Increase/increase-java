...
class InboundCheckDeposit @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** The Account Number the check is being deposited against. */
        fun accountNumberId(accountNumberId: Optional<String>) = accountNumberId(accountNumberId.getOrNull())
         ...
         * Check21 and the value will be null.
         */
        fun bankOfFirstDepositRoutingNumber(bankOfFirstDepositRoutingNumber: Optional<String>) = bankOfFirstDepositRoutingNumber(bankOfFirstDepositRoutingNumber.getOrNull())
         ...
         * Transaction object created as a result of the failed deposit.
         */
        fun declinedTransactionId(declinedTransactionId: Optional<String>) = declinedTransactionId(declinedTransactionId.getOrNull())
