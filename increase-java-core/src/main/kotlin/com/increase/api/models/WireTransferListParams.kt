...
class WireTransferListParams constructor(private val cursor: String?,private val limit: Long?,private val accountId: String?,private val externalAccountId: String?,private val createdAt: CreatedAt?,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    override fun toString() = "WireTransferListParams{cursor=$cursor, limit=$limit, accountId=$accountId, externalAccountId=$externalAccountId, createdAt=$createdAt, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
