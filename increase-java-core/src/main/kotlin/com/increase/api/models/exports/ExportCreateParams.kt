...
class ExportCreateParams private constructor(
     ...
     */
    fun bookkeepingAccountBalanceCsv(): Optional<BookkeepingAccountBalanceCsv> = body.bookkeepingAccountBalanceCsv()
    ...
    class Body @JsonCreator private constructor(
         ...
         * `account_statement_ofx`.
         */
        fun accountStatementOfx(): Optional<AccountStatementOfx> = Optional.ofNullable(accountStatementOfx.getNullable("account_statement_ofx"))

        /**
         * Options for the created export. Required if `category` is equal to
         * `balance_csv`.
         */
        fun balanceCsv(): Optional<BalanceCsv> = Optional.ofNullable(balanceCsv.getNullable("balance_csv"))

        /**
         * Options for the created export. Required if `category` is equal to
         * `bookkeeping_account_balance_csv`.
         */
        fun bookkeepingAccountBalanceCsv(): Optional<BookkeepingAccountBalanceCsv> = Optional.ofNullable(bookkeepingAccountBalanceCsv.getNullable("bookkeeping_account_balance_csv"))

        /** Options for the created export. Required if `category` is equal to `entity_csv`. */
        fun entityCsv(): Optional<EntityCsv> = Optional.ofNullable(entityCsv.getNullable("entity_csv"))

        /**
         * Options for the created export. Required if `category` is equal to
         * `transaction_csv`.
         */
        fun transactionCsv(): Optional<TransactionCsv> = Optional.ofNullable(transactionCsv.getNullable("transaction_csv"))
    ...
    class AccountStatementOfx @JsonCreator private constructor(
        ...
        fun createdAt(): Optional<CreatedAt> = Optional.ofNullable(createdAt.getNullable("created_at"))
        ...
        class CreatedAt @JsonCreator private constructor(
             ...
             * timestamp.
             */
            fun before(): Optional<OffsetDateTime> = Optional.ofNullable(before.getNullable("before"))

            /**
             * Return results on or after this
             * [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) timestamp.
             */
            fun onOrAfter(): Optional<OffsetDateTime> = Optional.ofNullable(onOrAfter.getNullable("on_or_after"))

            /**
             * Return results on or before this
             * [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) timestamp.
             */
            fun onOrBefore(): Optional<OffsetDateTime> = Optional.ofNullable(onOrBefore.getNullable("on_or_before"))
    ...
    class BookkeepingAccountBalanceCsv @JsonCreator private constructor(
        ...
        fun bookkeepingAccountId(): Optional<String> = Optional.ofNullable(bookkeepingAccountId.getNullable("bookkeeping_account_id"))
