...
class CardProfileListPage private constructor(private val cardProfilesService: CardProfileService,private val params: CardProfileListParams,private val response: Response,) {
    ...
    override fun toString() = "CardProfileListPage{cardProfilesService=$cardProfilesService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<CardProfileListPage> {
      return getNextPageParams().map { cardProfilesService.list(it) }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(cardProfilesService: CardProfileService, params: CardProfileListParams, response: Response) = CardProfileListPage(
            cardProfilesService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<CardProfile>>,private val nextCursor: JsonField<String>,private val additionalProperties: Map<String, JsonValue>,) {
        ...
        override fun toString() = "CardProfileListPage.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: CardProfileListPage,) : Iterable<CardProfile> {

        override fun iterator(): Iterator<CardProfile> = sequence {
            var page = firstPage
            var index = 0
            while (true) {
