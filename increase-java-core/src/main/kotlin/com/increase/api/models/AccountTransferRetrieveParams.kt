...
class AccountTransferRetrieveParams constructor(private val accountTransferId: String,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    override fun toString() = "AccountTransferRetrieveParams{accountTransferId=$accountTransferId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
