...
class DigitalWalletTokenRequestCreateResponse @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
         ...
         * as to why.
         */
        fun declineReason(declineReason: Optional<DeclineReason>) = declineReason(declineReason.getOrNull())
    ...
    class Type @JsonCreator private constructor(
        ...
        companion object {
            ...
            @JvmField val INBOUND_DIGITAL_WALLET_TOKEN_REQUEST_SIMULATION_RESULT = of("inbound_digital_wallet_token_request_simulation_result")
