...
class AchPrenotificationRetrieveParams constructor(private val achPrenotificationId: String,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    override fun toString() = "AchPrenotificationRetrieveParams{achPrenotificationId=$achPrenotificationId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
