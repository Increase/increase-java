...
class EventSubscriptionRetrieveParams constructor(private val eventSubscriptionId: String,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    override fun toString() = "EventSubscriptionRetrieveParams{eventSubscriptionId=$eventSubscriptionId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
