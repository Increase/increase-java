...
private constructor(
    ...
    fun cardAuthenticationChallenge(): Optional<CardAuthenticationChallenge> =
        cardAuthenticationChallenge.getOptional("card_authentication_challenge")
     ...
     *   server responded with an unexpected value).
     */
    fun cardBalanceInquiry(): Optional<CardBalanceInquiry> =
    ...
    fun digitalWalletAuthentication(): Optional<DigitalWalletAuthentication> =
        digitalWalletAuthentication.getOptional("digital_wallet_authentication")
    ...
    fun digitalWalletToken(): Optional<DigitalWalletToken> =
        digitalWalletToken.getOptional("digital_wallet_token")
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [Builder.cardAuthentication] with `cardAuthentication.orElse(null)`.
         */
         ...
         */
        fun cardBalanceInquiry(cardBalanceInquiry: Optional<CardBalanceInquiry>) =
        ...
        /**
         * Alias for calling [Builder.digitalWalletToken] with `digitalWalletToken.orElse(null)`.
         */
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (digitalWalletToken.asKnown().getOrNull()?.validity() ?: 0) +
            (status.asKnown().getOrNull()?.validity() ?: 0) +
            (if (timeoutAt.asKnown().isPresent) 1 else 0) +
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (if (accountId.asKnown().isPresent) 1 else 0) +
                ...
                (requestDetails.asKnown().getOrNull()?.validity() ?: 0) +
        ...
        private constructor(
             ...
             *   if the server responded with an unexpected value).
             */
            fun prescription(): Optional<Prescription> = prescription.getOptional("prescription")
        ...
        private constructor(
             ...
             *   if the server responded with an unexpected value).
             */
            fun pulse(): Optional<Pulse> = pulse.getOptional("pulse")
            ...
            class Builder internal constructor() {
                ...
                /** Alias for calling [Builder.pulse] with `pulse.orElse(null)`. */
                fun pulse(pulse: Optional<Pulse>) = pulse(pulse.getOrNull())
            ...
            internal fun validity(): Int =
                (category.asKnown().getOrNull()?.validity() ?: 0) +
                    (pulse.asKnown().getOrNull()?.validity() ?: 0) +
            ...
            private constructor(
                 ...
                 *   (e.g. if the server responded with an unexpected value).
                 */
                fun terminalEntryCapability(): Optional<TerminalEntryCapability> =
                    terminalEntryCapability.getOptional("terminal_entry_capability")
                ...
                class Builder internal constructor() {
                    ...
                    /**
                     * Alias for calling [Builder.terminalEntryCapability] with
                     * `terminalEntryCapability.orElse(null)`.
                     */
                    fun terminalEntryCapability(
                        terminalEntryCapability: Optional<TerminalEntryCapability>
                    ) = terminalEntryCapability(terminalEntryCapability.getOrNull())
                ...
                fun validate(): Visa = apply {
                    ...
                    terminalEntryCapability().ifPresent { it.validate() }
                    validated = true
                }
                ...
                internal fun validity(): Int =
                    (electronicCommerceIndicator.asKnown().getOrNull()?.validity() ?: 0) +
                        ...
                        (terminalEntryCapability.asKnown().getOrNull()?.validity() ?: 0)
                ...
                private constructor(private val value: JsonField<String>) : Enum {
                    ...
                    companion object {
                        ...
                        @JvmField val TERMINAL_NOT_USED = of("terminal_not_used")
                         ...
                         */
                        @JvmField val CHIP_OR_CONTACTLESS = of("chip_or_contactless")
                         ...
                         */
                        @JvmField val CONTACTLESS_ONLY = of("contactless_only")

                        /** The terminal has no card reading capability. */
                        @JvmField val NO_CAPABILITY = of("no_capability")
        ...
        private constructor(
            ...
            fun incrementalAuthorization(): Optional<IncrementalAuthorization> =
                incrementalAuthorization.getOptional("incremental_authorization")
             ...
             *   if the server responded with an unexpected value).
             */
            fun initialAuthorization(): Optional<InitialAuthorization> =
                initialAuthorization.getOptional("initial_authorization")
            ...
            class Builder internal constructor() {
                ...
                /**
                 * Alias for calling [Builder.incrementalAuthorization] with
                 * `incrementalAuthorization.orElse(null)`.
                 */
                ...
                /**
                 * Alias for calling [Builder.initialAuthorization] with
                 * `initialAuthorization.orElse(null)`.
                 */
                fun initialAuthorization(initialAuthorization: Optional<InitialAuthorization>) =
                    initialAuthorization(initialAuthorization.getOrNull())
            ...
            fun validate(): RequestDetails = apply {
                ...
                initialAuthorization().ifPresent { it.validate() }
                validated = true
            }
            ...
            internal fun validity(): Int =
                (category.asKnown().getOrNull()?.validity() ?: 0) +
                    (incrementalAuthorization.asKnown().getOrNull()?.validity() ?: 0) +
                    (initialAuthorization.asKnown().getOrNull()?.validity() ?: 0)
            ...
            private constructor(
                ...
                internal fun validity(): Int =
                    (if (cardPaymentId.asKnown().isPresent) 1 else 0) +
                        (if (originalCardAuthorizationId.asKnown().isPresent) 1 else 0)
        ...
        private constructor(
            ...
            private constructor(
                 ...
                 *   (e.g. if the server responded with an unexpected value).
                 */
                fun providedLine1(): Optional<String> = providedLine1.getOptional("provided_line1")
                ...
                class Builder internal constructor() {
                    ...
                    /**
                     * Alias for calling [Builder.providedLine1] with `providedLine1.orElse(null)`.
                     */
    ...
    private constructor(
        ...
        private constructor(
             ...
             * Used for best match union deserialization.
             */
            @JvmSynthetic internal fun validity(): Int = (if (balance.asKnown().isPresent) 1 else 0)
    ...
    class Category @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CARD_BALANCE_INQUIRY_REQUESTED = of("card_balance_inquiry_requested")
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (if (cardId.asKnown().isPresent) 1 else 0) +
                ...
                (if (oneTimePasscode.asKnown().isPresent) 1 else 0) +
