...
@NoAutoDetect
class WireTransferSimulation private constructor(private val transaction: JsonField<Transaction>,private val type: JsonField<Type>,private val additionalProperties: Map<String, JsonValue>,) {
    ...
    override fun toString() = "WireTransferSimulation{transaction=$transaction, type=$type, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        fun build(): WireTransferSimulation = WireTransferSimulation(
            transaction,
            type,
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>,) {
        ...
        companion object {
            ...
            @JvmField val INBOUND_WIRE_TRANSFER_SIMULATION_RESULT = Type(JsonField.of("inbound_wire_transfer_simulation_result"))
        ...
        fun value(): Value = when (this) {
            INBOUND_WIRE_TRANSFER_SIMULATION_RESULT -> Value.INBOUND_WIRE_TRANSFER_SIMULATION_RESULT
            else -> Value._UNKNOWN
        }

        fun known(): Known = when (this) {
            INBOUND_WIRE_TRANSFER_SIMULATION_RESULT -> Known.INBOUND_WIRE_TRANSFER_SIMULATION_RESULT
            else -> throw IncreaseInvalidDataException("Unknown Type: $value")
        }
