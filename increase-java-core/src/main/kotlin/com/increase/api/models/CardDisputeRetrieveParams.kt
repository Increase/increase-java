...
class CardDisputeRetrieveParams constructor(private val cardDisputeId: String,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    override fun toString() = "CardDisputeRetrieveParams{cardDisputeId=$cardDisputeId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
