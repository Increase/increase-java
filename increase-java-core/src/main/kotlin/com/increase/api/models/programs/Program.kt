...
class Program @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** The Program billing account. */
        fun billingAccountId(billingAccountId: Optional<String>) = billingAccountId(billingAccountId.getOrNull())
        ...
        /** The default configuration for digital cards attached to this Program. */
        fun defaultDigitalCardProfileId(defaultDigitalCardProfileId: Optional<String>) = defaultDigitalCardProfileId(defaultDigitalCardProfileId.getOrNull())
