...
class LockboxRetrieveParams constructor(private val lockboxId: String, private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
    ...
    override fun toString() = "LockboxRetrieveParams{lockboxId=$lockboxId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
