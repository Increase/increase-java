...
class BookkeepingEntryRetrieveParams constructor(private val bookkeepingEntryId: String, private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
    ...
    override fun toString() = "BookkeepingEntryRetrieveParams{bookkeepingEntryId=$bookkeepingEntryId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
