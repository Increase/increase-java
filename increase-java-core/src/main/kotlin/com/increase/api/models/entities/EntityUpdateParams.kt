...
private constructor(
    ...
    private constructor(
         ...
         *   the server responded with an unexpected value).
         */
        fun soleProprietor(): Optional<SoleProprietor> =
            soleProprietor.getOptional("sole_proprietor")
        ...
        fun validate(): SoleProprietorship = apply {
            ...
            address().ifPresent { it.validate() }
            email()
            soleProprietor().ifPresent { it.validate() }
            taxIdentifier()
            website()
            validated = true
        }
    ...
    private constructor(
         ...
         *   the server responded with an unexpected value).
         */
        fun trustees(): Optional<List<Trustee>> = trustees.getOptional("trustees")
        ...
        fun validate(): Trust = apply {
            ...
            name()
            trustees().ifPresent { it.forEach { it.validate() } }
            validated = true
        }
