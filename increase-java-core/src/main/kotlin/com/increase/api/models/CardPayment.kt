    ...
    class Element private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            @JsonProperty("other")
            @ExcludeMissing
            fun other(other: JsonValue) = apply {
                this.other = other
            }
        ...
        class CardRefund private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            fun interchange(): Optional<Interchange> = Optional.ofNullable(interchange.getNullable("interchange"))
            ...
            override fun toString() = "CardRefund{amount=$amount, cardPaymentId=$cardPaymentId, currency=$currency, id=$id, interchange=$interchange, merchantAcceptorId=$merchantAcceptorId, merchantCategoryCode=$merchantCategoryCode, merchantCity=$merchantCity, merchantCountry=$merchantCountry, merchantName=$merchantName, merchantState=$merchantState, networkIdentifiers=$networkIdentifiers, presentmentAmount=$presentmentAmount, presentmentCurrency=$presentmentCurrency, purchaseDetails=$purchaseDetails, transactionId=$transactionId, type=$type, additionalProperties=$additionalProperties}"
            ...
            @NoAutoDetect
            class Interchange private constructor(
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                override fun toString() = "Interchange{amount=$amount, code=$code, currency=$currency, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    fun build(): Interchange = Interchange(
                        amount,
                        code,
                        currency,
                        additionalProperties.toUnmodifiable(),
        ...
        class CardReversal private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            fun reversalReason(): Optional<ReversalReason> = Optional.ofNullable(reversalReason.getNullable("reversal_reason"))
            ...
            @ExcludeMissing
            fun _reversalReason() = reversalReason
            ...
            class Builder {
                ...
                /** Why this reversal was initiated. */
                fun reversalReason(reversalReason: ReversalReason) = reversalReason(JsonField.of(reversalReason))
            ...
            class ReversalReason @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is ReversalReason &&
                      this.value == other.value
                }
                ...
                companion object {
                    ...
                    @JvmField val REVERSED_BY_CUSTOMER = ReversalReason(JsonField.of("reversed_by_customer"))

                    @JvmField val REVERSED_BY_NETWORK_OR_ACQUIRER = ReversalReason(JsonField.of("reversed_by_network_or_acquirer"))

                    @JvmField val REVERSED_BY_POINT_OF_SALE = ReversalReason(JsonField.of("reversed_by_point_of_sale"))

                    @JvmField val PARTIAL_REVERSAL = ReversalReason(JsonField.of("partial_reversal"))
        ...
        class CardSettlement private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            override fun toString() = "CardSettlement{amount=$amount, cardAuthorization=$cardAuthorization, cardPaymentId=$cardPaymentId, currency=$currency, id=$id, interchange=$interchange, merchantAcceptorId=$merchantAcceptorId, merchantCategoryCode=$merchantCategoryCode, merchantCity=$merchantCity, merchantCountry=$merchantCountry, merchantName=$merchantName, merchantState=$merchantState, networkIdentifiers=$networkIdentifiers, pendingTransactionId=$pendingTransactionId, presentmentAmount=$presentmentAmount, presentmentCurrency=$presentmentCurrency, purchaseDetails=$purchaseDetails, transactionId=$transactionId, type=$type, additionalProperties=$additionalProperties}"
