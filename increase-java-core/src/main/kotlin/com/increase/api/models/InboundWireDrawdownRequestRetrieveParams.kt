...
class InboundWireDrawdownRequestRetrieveParams constructor(private val inboundWireDrawdownRequestId: String,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    override fun toString() = "InboundWireDrawdownRequestRetrieveParams{inboundWireDrawdownRequestId=$inboundWireDrawdownRequestId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
