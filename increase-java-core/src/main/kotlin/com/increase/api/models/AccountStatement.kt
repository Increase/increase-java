...
@NoAutoDetect
class AccountStatement private constructor(private val id: JsonField<String>,private val accountId: JsonField<String>,private val createdAt: JsonField<OffsetDateTime>,private val fileId: JsonField<String>,private val statementPeriodStart: JsonField<OffsetDateTime>,private val statementPeriodEnd: JsonField<OffsetDateTime>,private val startingBalance: JsonField<Long>,private val endingBalance: JsonField<Long>,private val type: JsonField<Type>,private val additionalProperties: Map<String, JsonValue>,) {
    ...
    override fun toString() = "AccountStatement{id=$id, accountId=$accountId, createdAt=$createdAt, fileId=$fileId, statementPeriodStart=$statementPeriodStart, statementPeriodEnd=$statementPeriodEnd, startingBalance=$startingBalance, endingBalance=$endingBalance, type=$type, additionalProperties=$additionalProperties}"
