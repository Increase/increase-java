...
class RealTimeDecisionRetrieveParams constructor(private val realTimeDecisionId: String,private val additionalQueryParams: Map<String, List<String>>,private val additionalHeaders: Map<String, List<String>>,) {
    ...
    override fun toString() = "RealTimeDecisionRetrieveParams{realTimeDecisionId=$realTimeDecisionId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
