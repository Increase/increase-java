...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun soleProprietorship(): Optional<SoleProprietorship> =
        soleProprietorship.getOptional("sole_proprietorship")
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [Builder.soleProprietorship] with `soleProprietorship.orElse(null)`.
         */
        fun soleProprietorship(soleProprietorship: Optional<SoleProprietorship>) =
            soleProprietorship(soleProprietorship.getOrNull())
        ...
        fun validation(validation: Optional<Validation>) = validation(validation.getOrNull())
    ...
    fun validate(): Entity = apply {
        ...
        soleProprietorship().ifPresent { it.validate() }
        status().validate()
        structure().validate()
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (joint.asKnown().getOrNull()?.validity() ?: 0) +
            (naturalPerson.asKnown().getOrNull()?.validity() ?: 0) +
            (riskRating.asKnown().getOrNull()?.validity() ?: 0) +
            (soleProprietorship.asKnown().getOrNull()?.validity() ?: 0) +
            (status.asKnown().getOrNull()?.validity() ?: 0) +
            (structure.asKnown().getOrNull()?.validity() ?: 0) +
            (supplementalDocuments.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    private constructor(
         ...
         *   the server responded with an unexpected value).
         */
        fun legalIdentifier(): Optional<LegalIdentifier> =
            legalIdentifier.getOptional("legal_identifier")
        ...
        class Builder internal constructor() {
            ...
            /**
             * Alias for calling [Builder.beneficialOwnershipExemptionReason] with
             * `beneficialOwnershipExemptionReason.orElse(null)`.
             */
            fun beneficialOwnershipExemptionReason(
                beneficialOwnershipExemptionReason: Optional<BeneficialOwnershipExemptionReason>
            ) = beneficialOwnershipExemptionReason(beneficialOwnershipExemptionReason.getOrNull())
            ...
            /** Alias for calling [Builder.legalIdentifier] with `legalIdentifier.orElse(null)`. */
            fun legalIdentifier(legalIdentifier: Optional<LegalIdentifier>) =
                legalIdentifier(legalIdentifier.getOrNull())
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                fun zip(zip: Optional<String>) = zip(zip.getOrNull())
        ...
        private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                @JvmField val PUBLICLY_TRADED_COMPANY = of("publicly_traded_company")

                /** A public entity acting on behalf of the federal or a state government. */
                @JvmField val PUBLIC_ENTITY = of("public_entity")
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (address.asKnown().getOrNull()?.validity() ?: 0) +
                (authorizedPersons.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
                (category.asKnown().getOrNull()?.validity() ?: 0) +
                (if (name.asKnown().isPresent) 1 else 0) +
        ...
        private constructor(
            ...
            @JvmSynthetic
            internal fun validity(): Int =
                (if (authorizedPersonId.asKnown().isPresent) 1 else 0) +
                    (if (name.asKnown().isPresent) 1 else 0)
    ...
    private constructor(
        ...
        @JvmSynthetic
        internal fun validity(): Int =
            (if (ratedAt.asKnown().isPresent) 1 else 0) +
    ...
    private constructor(
         ...
         *   the server responded with an unexpected value).
         */
        fun doingBusinessAsName(): Optional<String> =
            doingBusinessAsName.getOptional("doing_business_as_name")
        ...
        class Builder internal constructor() {
            ...
            /**
             * Alias for calling [Builder.doingBusinessAsName] with
             * `doingBusinessAsName.orElse(null)`.
             */
            fun doingBusinessAsName(doingBusinessAsName: Optional<String>) =
                doingBusinessAsName(doingBusinessAsName.getOrNull())
        ...
        internal fun validity(): Int =
            (address.asKnown().getOrNull()?.validity() ?: 0) +
                (if (doingBusinessAsName.asKnown().isPresent) 1 else 0) +
                (if (email.asKnown().isPresent) 1 else 0) +
                (if (industryCode.asKnown().isPresent) 1 else 0) +
                (soleProprietor.asKnown().getOrNull()?.validity() ?: 0) +
                (if (taxIdentifier.asKnown().isPresent) 1 else 0) +
                (if (website.asKnown().isPresent) 1 else 0)
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (address.asKnown().getOrNull()?.validity() ?: 0) +
                (category.asKnown().getOrNull()?.validity() ?: 0) +
                (if (formationDocumentFileId.asKnown().isPresent) 1 else 0) +
                (if (formationState.asKnown().isPresent) 1 else 0) +
                (grantor.asKnown().getOrNull()?.validity() ?: 0) +
                (if (name.asKnown().isPresent) 1 else 0) +
                (if (taxIdentifier.asKnown().isPresent) 1 else 0) +
                (trustees.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
    ...
    private constructor(
        ...
        private constructor(
             ...
             *   if the server responded with an unexpected value).
             */
            fun beneficialOwnerAddress(): Optional<BeneficialOwnerAddress> =
             ...
             *   if the server responded with an unexpected value).
             */
            fun entityAddress(): Optional<EntityAddress> =
             ...
             *   if the server responded with an unexpected value).
             */
            fun entityIdentity(): Optional<EntityIdentity> =
                entityIdentity.getOptional("entity_identity")
             ...
             *   if the server responded with an unexpected value).
             */
            fun entityTaxIdentifier(): Optional<EntityTaxIdentifier> =
            ...
            class Builder internal constructor() {
                ...
                fun beneficialOwnerAddress(
                    beneficialOwnerAddress: Optional<BeneficialOwnerAddress>
                ...
                fun beneficialOwnerIdentity(
                    beneficialOwnerIdentity: Optional<BeneficialOwnerIdentity>
                ...
                fun entityAddress(entityAddress: Optional<EntityAddress>) =
                ...
                /**
                 * Alias for calling [Builder.entityIdentity] with `entityIdentity.orElse(null)`.
                 */
                fun entityIdentity(entityIdentity: Optional<EntityIdentity>) =
                    entityIdentity(entityIdentity.getOrNull())
                 ...
                 */
                fun entityTaxIdentifier(entityTaxIdentifier: Optional<EntityTaxIdentifier>) =
