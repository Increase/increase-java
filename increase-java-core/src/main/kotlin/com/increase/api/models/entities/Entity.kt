...
class Entity @JsonCreator private constructor(
     ...
     */
    fun thirdPartyVerification(): Optional<ThirdPartyVerification> = Optional.ofNullable(thirdPartyVerification.getNullable("third_party_verification"))
    ...
    class Builder internal constructor() {
         ...
         * Entity's details were most recently confirmed.
         */
        fun detailsConfirmedAt(detailsConfirmedAt: Optional<OffsetDateTime>) = detailsConfirmedAt(detailsConfirmedAt.getOrNull())
         ...
         * equal to `government_authority`.
         */
        fun governmentAuthority(governmentAuthority: Optional<GovernmentAuthority>) = governmentAuthority(governmentAuthority.getOrNull())
         ...
         * `natural_person`.
         */
        fun naturalPerson(naturalPerson: Optional<NaturalPerson>) = naturalPerson(naturalPerson.getOrNull())
    ...
    class Corporation @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
             ...
             * corporation's state of incorporation.
             */
            fun incorporationState(incorporationState: Optional<String>) = incorporationState(incorporationState.getOrNull())
             ...
             * for the corporation.
             */
            fun industryCode(industryCode: Optional<String>) = industryCode(industryCode.getOrNull())
            ...
            /** The Employer Identification Number (EIN) for the corporation. */
            fun taxIdentifier(taxIdentifier: Optional<String>) = taxIdentifier(taxIdentifier.getOrNull())
        ...
        class BeneficialOwner @JsonCreator private constructor(
            ...
            class Builder internal constructor() {
                ...
                /** This person's role or title within the entity. */
                fun companyTitle(companyTitle: Optional<String>) = companyTitle(companyTitle.getOrNull())
                ...
                class Identification @JsonCreator private constructor(
                    ...
                    class Method @JsonCreator private constructor(
                        ...
                        companion object {
                            ...
                            @JvmField val INDIVIDUAL_TAXPAYER_IDENTIFICATION_NUMBER = of("individual_taxpayer_identification_number")
    ...
    class Trust @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** The ID for the File containing the formation document of the trust. */
            fun formationDocumentFileId(formationDocumentFileId: Optional<String>) = formationDocumentFileId(formationDocumentFileId.getOrNull())
             ...
             * which the trust was formed.
             */
            fun formationState(formationState: Optional<String>) = formationState(formationState.getOrNull())
        ...
        class Trustee @JsonCreator private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 * `structure` is equal to `individual`.
                 */
                fun individual(individual: Optional<Individual>) = individual(individual.getOrNull())
