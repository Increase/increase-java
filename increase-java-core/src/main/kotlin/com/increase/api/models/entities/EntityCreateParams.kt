...
class EntityCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        /** Additional documentation associated with the entity. */
        fun supplementalDocuments(): Optional<List<SupplementalDocument>> = Optional.ofNullable(supplementalDocuments.getNullable("supplemental_documents"))
    ...
    class Corporation @JsonCreator private constructor(
        ...
        class BeneficialOwner @JsonCreator private constructor(
            ...
            class Individual @JsonCreator private constructor(
                 ...
                 * Number).
                 */
                fun confirmedNoUsTaxId(): Optional<Boolean> = Optional.ofNullable(confirmedNoUsTaxId.getNullable("confirmed_no_us_tax_id"))
                ...
                class Identification @JsonCreator private constructor(
                     ...
                     */
                    fun driversLicense(): Optional<DriversLicense> = Optional.ofNullable(driversLicense.getNullable("drivers_license"))
                     ...
                     * equal to `passport`.
                     */
                    fun passport(): Optional<Passport> = Optional.ofNullable(passport.getNullable("passport"))
                    ...
                    class DriversLicense @JsonCreator private constructor(
                        ...
                        fun backFileId(): Optional<String> = Optional.ofNullable(backFileId.getNullable("back_file_id"))
                    ...
                    class Other @JsonCreator private constructor(
                        ...
                        fun expirationDate(): Optional<LocalDate> = Optional.ofNullable(expirationDate.getNullable("expiration_date"))
